...
#ifdef TRAPMETERING
char *trapnames[TrapMeter_NEntries] = { "StackOverflow", "InstructionException", "ArithmeticInstructionException",
    "Error", "Reset", "PullApplyArgs", "Trace", "PreemptRequest", "LowPrioritySequenceBreak",
    "HighPrioritySequenceBreak", "DBUnwindFrame", "DBUnwindCatch", "Transport", "Monitor", "PageNotResident",
    "PageFaultRequest", "PageWriteFault", "UncorrectableMemoryError", "MemoryBusError", "DBCacheMiss" };
