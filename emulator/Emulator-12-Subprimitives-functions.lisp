...
(define-instruction |DoPointerDifference| :operand-from-stack-immediate (:own-immediate t)
  ...
  (EXTLL arg1 0 t2 "Get the data of ARG2") ;(EXTLL t1 0 t1)
...
(define-instruction |DoMemoryWrite| :operand-from-stack-signed-immediate ()
  ...
  (SRL arg1 32 arg2)
  (EXTLL arg1 0 arg1) ;; Perform a RAW write
  (memory-write arg4 arg2 arg1 PROCESSORSTATE_RAW t1 t2 t3 t4 t5 NextInstruction)
...
(define-instruction |DoPStoreContents| :operand-from-stack-signed-immediate ()
  ...
  (SRL arg1 32 arg2)
  (EXTLL arg1 0 arg1)
  (store-contents arg4 arg2 arg1 PROCESSORSTATE_RAW t4 t5 t6 t7 t8 t9 NextInstruction)
  (ContinueToNextInstruction))
