...
extern void DoSetupForce1DArrayFP(void), DoSetupForce1DArrayLP(void), DoSetupForce1DArraySP(void),
    DoSetupForce1DArrayIM(void);
extern void DoBindLocativeFP(void), DoBindLocativeLP(void), DoBindLocativeSP(void), DoBindLocativeIM(void);
extern void DoRestoreBindingStackFP(void), DoRestoreBindingStackLP(void), DoRestoreBindingStackSP(void),
    DoRestoreBindingStackIM(void);
...
extern void DoCheckPreemptRequestFP(void), DoCheckPreemptRequestLP(void), DoCheckPreemptRequestSP(void),
    DoCheckPreemptRequestIM(void);
extern void DoPushGlobalLogicVariableFP(void), DoPushGlobalLogicVariableLP(void), DoPushGlobalLogicVariableSP(void),
...
extern void DoBranchTrueElseExtraPopFP(void), DoBranchTrueElseExtraPopLP(void), DoBranchTrueElseExtraPopSP(void),
    DoBranchTrueElseExtraPopIM(void);
extern void DoBranchTrueAndExtraPopFP(void), DoBranchTrueAndExtraPopLP(void), DoBranchTrueAndExtraPopSP(void),
    DoBranchTrueAndExtraPopIM(void);
extern void DoBranchTrueExtraPopFP(void), DoBranchTrueExtraPopLP(void), DoBranchTrueExtraPopSP(void),
    DoBranchTrueExtraPopIM(void);
extern void DoBranchTrueNoPopFP(void), DoBranchTrueNoPopLP(void), DoBranchTrueNoPopSP(void), DoBranchTrueNoPopIM(void);
extern void DoBranchTrueAndNoPopFP(void), DoBranchTrueAndNoPopLP(void), DoBranchTrueAndNoPopSP(void),
    DoBranchTrueAndNoPopIM(void);
extern void DoBranchTrueElseNoPopFP(void), DoBranchTrueElseNoPopLP(void), DoBranchTrueElseNoPopSP(void),
    DoBranchTrueElseNoPopIM(void);
extern void DoBranchTrueAndNoPopElseNoPopExtraPopFP(void), DoBranchTrueAndNoPopElseNoPopExtraPopLP(void),
    DoBranchTrueAndNoPopElseNoPopExtraPopSP(void), DoBranchTrueAndNoPopElseNoPopExtraPopIM(void);
extern void DoBranchFalseFP(void), DoBranchFalseLP(void), DoBranchFalseSP(void), DoBranchFalseIM(void);
extern void DoBranchFalseElseExtraPopFP(void), DoBranchFalseElseExtraPopLP(void), DoBranchFalseElseExtraPopSP(void),
    DoBranchFalseElseExtraPopIM(void);
extern void DoBranchFalseAndExtraPopFP(void), DoBranchFalseAndExtraPopLP(void), DoBranchFalseAndExtraPopSP(void),
    DoBranchFalseAndExtraPopIM(void);
extern void DoBranchFalseExtraPopFP(void), DoBranchFalseExtraPopLP(void), DoBranchFalseExtraPopSP(void),
    DoBranchFalseExtraPopIM(void);
extern void DoBranchFalseNoPopFP(void), DoBranchFalseNoPopLP(void), DoBranchFalseNoPopSP(void),
    DoBranchFalseNoPopIM(void);
extern void DoBranchFalseAndNoPopFP(void), DoBranchFalseAndNoPopLP(void), DoBranchFalseAndNoPopSP(void),
    DoBranchFalseAndNoPopIM(void);
extern void DoBranchFalseElseNoPopFP(void), DoBranchFalseElseNoPopLP(void), DoBranchFalseElseNoPopSP(void),
    DoBranchFalseElseNoPopIM(void);
extern void DoBranchFalseAndNoPopElseNoPopExtraPopFP(void), DoBranchFalseAndNoPopElseNoPopExtraPopLP(void),
    DoBranchFalseAndNoPopElseNoPopExtraPopSP(void), DoBranchFalseAndNoPopElseNoPopExtraPopIM(void);
...
extern void DoPushAddressSpRelativeFP(void), DoPushAddressSpRelativeLP(void), DoPushAddressSpRelativeSP(void),
    DoPushAddressSpRelativeIM(void);
extern void DoPushLocalLogicVariablesFP(void), DoPushLocalLogicVariablesLP(void), DoPushLocalLogicVariablesSP(void),
...
extern void DoPushInstanceVariableFP(void), DoPushInstanceVariableLP(void), DoPushInstanceVariableSP(void),
    DoPushInstanceVariableIM(void);
extern void DoPushAddressInstanceVariableFP(void), DoPushAddressInstanceVariableLP(void),
    DoPushAddressInstanceVariableSP(void), DoPushAddressInstanceVariableIM(void);
extern void DoPushInstanceVariableOrderedFP(void), DoPushInstanceVariableOrderedLP(void),
    DoPushInstanceVariableOrderedSP(void), DoPushInstanceVariableOrderedIM(void);
extern void DoPushAddressInstanceVariableOrderedFP(void), DoPushAddressInstanceVariableOrderedLP(void),
    DoPushAddressInstanceVariableOrderedSP(void), DoPushAddressInstanceVariableOrderedIM(void);
...
extern void DoPointerIncrementFP(void), DoPointerIncrementLP(void), DoPointerIncrementSP(void),
    DoPointerIncrementIM(void);
...
extern void DoSetSpToAddressSaveTosFP(void), DoSetSpToAddressSaveTosLP(void), DoSetSpToAddressSaveTosSP(void),
    DoSetSpToAddressSaveTosIM(void);
extern void DoReadInternalRegisterFP(void), DoReadInternalRegisterLP(void), DoReadInternalRegisterSP(void),
    DoReadInternalRegisterIM(void);
extern void DoWriteInternalRegisterFP(void), DoWriteInternalRegisterLP(void), DoWriteInternalRegisterSP(void),
    DoWriteInternalRegisterIM(void);
extern void DoCoprocessorReadFP(void), DoCoprocessorReadLP(void), DoCoprocessorReadSP(void), DoCoprocessorReadIM(void);
extern void DoCoprocessorWriteFP(void), DoCoprocessorWriteLP(void), DoCoprocessorWriteSP(void),
    DoCoprocessorWriteIM(void);
...
extern void DoLoopDecrementTosFP(void), DoLoopDecrementTosLP(void), DoLoopDecrementTosSP(void),
    DoLoopDecrementTosIM(void);
extern void DoEntryRestAcceptedFP(void), DoEntryRestAcceptedLP(void), DoEntryRestAcceptedSP(void),
    DoEntryRestAcceptedIM(void);
extern void DoEntryRestNotAcceptedFP(void), DoEntryRestNotAcceptedLP(void), DoEntryRestNotAcceptedSP(void),
    DoEntryRestNotAcceptedIM(void);
...
extern void DoRationalQuotientFP(void), DoRationalQuotientLP(void), DoRationalQuotientSP(void),
    DoRationalQuotientIM(void);
...
extern void DoPointerDifferenceFP(void), DoPointerDifferenceLP(void), DoPointerDifferenceSP(void),
    DoPointerDifferenceIM(void);
extern void DoAshFP(void), DoAshLP(void), DoAshSP(void), DoAshIM(void);
extern void DoStoreConditionalFP(void), DoStoreConditionalLP(void), DoStoreConditionalSP(void),
    DoStoreConditionalIM(void);
...
extern void DoBindLocativeToValueFP(void), DoBindLocativeToValueLP(void), DoBindLocativeToValueSP(void),
    DoBindLocativeToValueIM(void);
...
extern void DoMovemLexicalVarNFP(void), DoMovemLexicalVarNLP(void), DoMovemLexicalVarNSP(void),
    DoMovemLexicalVarNIM(void);
...
extern void DoMultiplyBignumStepFP(void), DoMultiplyBignumStepLP(void), DoMultiplyBignumStepSP(void),
    DoMultiplyBignumStepIM(void);
extern void DoDivideBignumStepFP(void), DoDivideBignumStepLP(void), DoDivideBignumStepSP(void),
    DoDivideBignumStepIM(void);
extern void DoAset1FP(void), DoAset1LP(void), DoAset1SP(void), DoAset1IM(void);
extern void DoAllocateListBlockFP(void), DoAllocateListBlockLP(void), DoAllocateListBlockSP(void),
    DoAllocateListBlockIM(void);
...
extern void DoStoreArrayLeaderFP(void), DoStoreArrayLeaderLP(void), DoStoreArrayLeaderSP(void),
    DoStoreArrayLeaderIM(void);
extern void DoAllocateStructureBlockFP(void), DoAllocateStructureBlockLP(void), DoAllocateStructureBlockSP(void),
...
extern void DoPopInstanceVariableFP(void), DoPopInstanceVariableLP(void), DoPopInstanceVariableSP(void),
    DoPopInstanceVariableIM(void);
extern void DoMovemInstanceVariableFP(void), DoMovemInstanceVariableLP(void), DoMovemInstanceVariableSP(void),
    DoMovemInstanceVariableIM(void);
extern void DoPopInstanceVariableOrderedFP(void), DoPopInstanceVariableOrderedLP(void),
    DoPopInstanceVariableOrderedSP(void), DoPopInstanceVariableOrderedIM(void);
extern void DoMovemInstanceVariableOrderedFP(void), DoMovemInstanceVariableOrderedLP(void),
    DoMovemInstanceVariableOrderedSP(void), DoMovemInstanceVariableOrderedIM(void);
...
extern void DoLoopIncrementTosLessThanFP(void), DoLoopIncrementTosLessThanLP(void), DoLoopIncrementTosLessThanSP(void),
