...
g1732:
  if (_trace) printf("g1732:\n");

g1718:
  if (_trace) printf("g1718:\n");

g1716:
  if (_trace) printf("g1716:\n");
  sp = sp + 8;
  goto *r0; /* ret */

g1719:
  if (_trace) printf("g1719:\n");
  t6 = (t5 == Type_NIL) ? 1 : 0;

g1763:
  if (_trace) printf("g1763:\n");
  if (t6 == 0)
    goto g1749;
...
g1754:
  if (_trace) printf("g1754:\n");

g1753:
  if (_trace) printf("g1753:\n");
  *(u64 *)sp = r0;
  r0 = (u64)&&return0053;
...
g1733:
  if (_trace) printf("g1733:\n");
  t6 = (t5 == 128) ? 1 : 0;

g1764:
  if (_trace) printf("g1764:\n");
  if (t6 == 0)
    goto g1734;
...
g1734:
  if (_trace) printf("g1734:\n");
  t6 = (t5 == 64) ? 1 : 0;

g1765:
  if (_trace) printf("g1765:\n");
  if (t6 == 0)
    goto g1746;
  /* Here if argument 64 */
  arg6 = *(s32 *)&processor->niladdress;
...
g1738:
  if (_trace) printf("g1738:\n");

g1737:
  if (_trace) printf("g1737:\n");
  *(u64 *)sp = r0;
  r0 = (u64)&&return0054;
...
g1723:
  if (_trace) printf("g1723:\n");

g1722:
  if (_trace) printf("g1722:\n");
  *(u64 *)sp = r0;
  r0 = (u64)&&return0055;
  goto memoryreaddatadecode;
return0055:
...
g1783:
  if (_trace) printf("g1783:\n");

g1769:
  if (_trace) printf("g1769:\n");

g1767:
  if (_trace) printf("g1767:\n");
...
g1770:
  if (_trace) printf("g1770:\n");
  t4 = (t3 == Type_NIL) ? 1 : 0;

g1814:
  if (_trace) printf("g1814:\n");
  if (t4 == 0)
    goto g1800;
  /* Here if argument TypeNIL */
  arg6 = *(s32 *)&processor->niladdress;
...
g1800:
  if (_trace) printf("g1800:\n");
  /* Here for all other cases */
  arg1 = arg1;
  goto pullapplyargstrap;

g1766:
  if (_trace) printf("g1766:\n");
  t2 = (u32)(arg4 >> ((zero&7)*8));
  arg3 = arg5;
  arg4 = arg6;
  /* Memory Read Internal */
...
g1784:
  if (_trace) printf("g1784:\n");
  t4 = (t3 == 128) ? 1 : 0;

g1815:
  if (_trace) printf("g1815:\n");
  if (t4 == 0)
    goto g1785;
  /* Here if argument 128 */
  t2 = t2 + 1;
...
g1785:
  if (_trace) printf("g1785:\n");
  t4 = (t3 == 64) ? 1 : 0;

g1816:
  if (_trace) printf("g1816:\n");
  if (t4 == 0)
    goto g1797;
  /* Here if argument 64 */
  arg6 = *(s32 *)&processor->niladdress;
...
g1860:
  if (_trace) printf("g1860:\n");

g1822:
  if (_trace) printf("g1822:\n");
  t3 = (256) << 16;
  t2 = t3 & arg5;
  if (t2 == 0)
    goto INTERPRETINSTRUCTION;
