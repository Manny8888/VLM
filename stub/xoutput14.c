...
g2820:
  if (_trace) printf("g2820:\n");
  arg5 = 0;
  arg2 = 1;
  goto illegaloperand;

g2821:
  if (_trace) printf("g2821:\n");
  /* SetTag. */
  t1 = arg2 << 32;
  t1 = arg1 | t1;
  /* arg3 = stackp */
...
g2822:
  if (_trace) printf("g2822:\n");
  arg5 = 0;
  arg2 = 1;
  goto illegaloperand;

g2823:
  if (_trace) printf("g2823:\n");
  /* SetTag. */
  t1 = arg2 << 32;
  t1 = arg1 | t1;
  /* arg3 = stackp */
...
g2837:
  if (_trace) printf("g2837:\n");
  t2 = *(u64 *)&(processor->stackcachebasevma);

g2839:
  if (_trace) printf("g2839:\n");
...
g2841:
  if (_trace) printf("g2841:\n");
  t2 = *(u64 *)&(processor->stackcachebasevma);

g2843:
  if (_trace) printf("g2843:\n");
  t1 = *(u64 *)&(processor->stackcachedata);
  /* Stack cache offset */
  t2 = arg4 - t2;
  /* reconstruct SCA */
...
g2854:
  if (_trace) printf("g2854:\n");
  t7 = *(u64 *)&(processor->stackcachebasevma);

g2856:
  if (_trace) printf("g2856:\n");
...
g2878:
  if (_trace) printf("g2878:\n");
  if (t1 != 0)
    goto g2860;

g2861:
  if (_trace) printf("g2861:\n");
  t1 = (t10 == Boole_And) ? 1 : 0;

g2879:
  if (_trace) printf("g2879:\n");
  if (t1 == 0)
    goto g2862;
...
g2862:
  if (_trace) printf("g2862:\n");
  t1 = (t10 == Boole_AndC1) ? 1 : 0;

g2880:
  if (_trace) printf("g2880:\n");
  if (t1 == 0)
    goto g2863;
...
g2863:
  if (_trace) printf("g2863:\n");
  t1 = (t10 == Boole_2) ? 1 : 0;

g2881:
  if (_trace) printf("g2881:\n");
  if (t1 == 0)
    goto g2864;
...
g2864:
  if (_trace) printf("g2864:\n");
  t1 = (t10 == Boole_AndC2) ? 1 : 0;

g2882:
  if (_trace) printf("g2882:\n");
  if (t1 == 0)
    goto g2865;
...
g2865:
  if (_trace) printf("g2865:\n");
  t1 = (t10 == Boole_1) ? 1 : 0;

g2883:
  if (_trace) printf("g2883:\n");
  if (t1 == 0)
    goto g2866;
...
g2866:
  if (_trace) printf("g2866:\n");
  t1 = (t10 == Boole_Xor) ? 1 : 0;

g2884:
  if (_trace) printf("g2884:\n");
  if (t1 == 0)
    goto g2867;
...
g2867:
  if (_trace) printf("g2867:\n");
  t1 = (t10 == Boole_Ior) ? 1 : 0;

g2885:
  if (_trace) printf("g2885:\n");
  if (t1 == 0)
    goto g2868;
...
g2868:
  if (_trace) printf("g2868:\n");
  t1 = (t10 == Boole_Nor) ? 1 : 0;

g2886:
  if (_trace) printf("g2886:\n");
  if (t1 == 0)
    goto g2869;
...
g2869:
  if (_trace) printf("g2869:\n");
  t1 = (t10 == Boole_Equiv) ? 1 : 0;

g2887:
  if (_trace) printf("g2887:\n");
  if (t1 == 0)
    goto g2870;
...
g2870:
  if (_trace) printf("g2870:\n");
  t1 = (t10 == Boole_C1) ? 1 : 0;

g2888:
  if (_trace) printf("g2888:\n");
  if (t1 == 0)
    goto g2871;
...
g2871:
  if (_trace) printf("g2871:\n");
  t1 = (t10 == Boole_OrC1) ? 1 : 0;

g2889:
  if (_trace) printf("g2889:\n");
  if (t1 == 0)
    goto g2872;
...
g2872:
  if (_trace) printf("g2872:\n");
  t1 = (t10 == Boole_C2) ? 1 : 0;

g2890:
  if (_trace) printf("g2890:\n");
  if (t1 == 0)
    goto g2873;
...
g2873:
  if (_trace) printf("g2873:\n");
  t1 = (t10 == Boole_OrC2) ? 1 : 0;

g2891:
  if (_trace) printf("g2891:\n");
  if (t1 == 0)
    goto g2874;
...
g2874:
  if (_trace) printf("g2874:\n");
  t1 = (t10 == Boole_Nand) ? 1 : 0;

g2892:
  if (_trace) printf("g2892:\n");
  if (t1 == 0)
    goto g2875;
...
g2875:
  if (_trace) printf("g2875:\n");
  t1 = (t10 == Boole_Set) ? 1 : 0;

g2893:
  if (_trace) printf("g2893:\n");
  if (t1 == 0)
    goto g2860;
...
g2860:
  if (_trace) printf("g2860:\n");
  *(u32 *)iSP = t10;
  goto NEXTINSTRUCTION;

g2859:
  if (_trace) printf("g2859:\n");
  t1 = (arg5 == ALUFunction_Byte) ? 1 : 0;

g2919:
  if (_trace) printf("g2919:\n");
  if (t1 == 0)
    goto g2894;
...
g2894:
  if (_trace) printf("g2894:\n");
  t1 = (arg5 == ALUFunction_Adder) ? 1 : 0;

g2920:
  if (_trace) printf("g2920:\n");
  if (t1 == 0)
    goto g2907;
...
g2907:
  if (_trace) printf("g2907:\n");
  t1 = (arg5 == ALUFunction_MultiplyDivide) ? 1 : 0;

g2921:
  if (_trace) printf("g2921:\n");
  if (t1 == 0)
    goto g2858;
...
g2910:
  if (_trace) printf("g2910:\n");
  t4 = (t3 == ALUAdderOp2_Zero) ? 1 : 0;

g2922:
  if (_trace) printf("g2922:\n");
  if (t4 == 0)
    goto g2911;
...
g2911:
  if (_trace) printf("g2911:\n");
  t4 = (t3 == ALUAdderOp2_Invert) ? 1 : 0;

g2923:
  if (_trace) printf("g2923:\n");
  if (t4 == 0)
    goto g2912;
...
g2912:
  if (_trace) printf("g2912:\n");
  t4 = (t3 == ALUAdderOp2_MinusOne) ? 1 : 0;

g2924:
  if (_trace) printf("g2924:\n");
  if (t4 == 0)
    goto g2909;
...
g2903:
  if (_trace) printf("g2903:\n");
  t3 = (t4 == ALUByteFunction_Ldb) ? 1 : 0;

g2925:
  if (_trace) printf("g2925:\n");
  if (t3 != 0)
    goto g2902;
  goto g2902;

g2897:
  if (_trace) printf("g2897:\n");
  t4 = (t1 == ALUByteBackground_RotateLatch) ? 1 : 0;

g2926:
  if (_trace) printf("g2926:\n");
  if (t4 == 0)
    goto g2898;
...
g2898:
  if (_trace) printf("g2898:\n");
  t4 = (t1 == ALUByteBackground_Zero) ? 1 : 0;

g2927:
  if (_trace) printf("g2927:\n");
  if (t4 == 0)
    goto g2896;
...
g2934:
  if (_trace) printf("g2934:\n");

g2929:
  if (_trace) printf("g2929:\n");
  goto NEXTINSTRUCTION;
