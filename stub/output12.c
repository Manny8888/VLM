...
dopushnnils : if (_trace) printf("dopushnnils:\n");

DoPushNNilsSP : if (_trace) printf("DoPushNNilsSP:\n");
...
DoPushNNilsLP : if (_trace) printf("DoPushNNilsLP:\n");

DoPushNNilsFP : if (_trace) printf("DoPushNNilsFP:\n");
...
dopushaddresssprelative : if (_trace) printf("dopushaddresssprelative:\n");
...
DoPushAddressSpRelativeLP : if (_trace) printf("DoPushAddressSpRelativeLP:\n");

DoPushAddressSpRelativeFP : if (_trace) printf("DoPushAddressSpRelativeFP:\n");
...
force_alignment45552 : if (_trace) printf("force_alignment45552:\n");
if (t3 == 0)
    goto basic_dispatch45549;
...
basic_dispatch45549 : if (_trace) printf("basic_dispatch45549:\n");
/* Here for all other cases */
arg5 = 0;
arg2 = 63;
goto illegaloperand;

basic_dispatch45548 : if (_trace) printf("basic_dispatch45548:\n");
...
dostackblt : if (_trace) printf("dostackblt:\n");
...
DoStackBltLP : if (_trace) printf("DoStackBltLP:\n");

DoStackBltFP : if (_trace) printf("DoStackBltFP:\n");
...
stkbltexc : if (_trace) printf("stkbltexc:\n");
arg5 = 0;
arg2 = 73;
goto illegaloperand;
...
dostackbltaddress : if (_trace) printf("dostackbltaddress:\n");

DoStackBltAddressSP : if (_trace) printf("DoStackBltAddressSP:\n");
arg1 = arg5; // Assume SP mode
if (arg2 == 0) // SP-pop mode
    arg1 = iSP;
if (arg2 == 0) // Adjust SP if SP-pop mode
...
DoStackBltAddressLP : if (_trace) printf("DoStackBltAddressLP:\n");

DoStackBltAddressFP : if (_trace) printf("DoStackBltAddressFP:\n");
...
stkbltaddloop : if (_trace) printf("stkbltaddloop:\n");
arg1 = arg1 + 8; // Advance Source
t6 = t6 + 8; // Advance destination
...
stkbltadrexc : if (_trace) printf("stkbltadrexc:\n");
arg5 = 0;
arg2 = 73;
goto illegaloperand;

DoStackBltAddressIM : goto doistageerror;
