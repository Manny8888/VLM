...
doaddbignumstep : if (_trace) printf("doaddbignumstep:\n");
...
DoAddBignumStepLP : if (_trace) printf("DoAddBignumStepLP:\n");

DoAddBignumStepFP : if (_trace) printf("DoAddBignumStepFP:\n");
...
dosubbignumstep : if (_trace) printf("dosubbignumstep:\n");
...
DoSubBignumStepLP : if (_trace) printf("DoSubBignumStepLP:\n");

DoSubBignumStepFP : if (_trace) printf("DoSubBignumStepFP:\n");
...
domultiplybignumstep : if (_trace) printf("domultiplybignumstep:\n");
...
DoMultiplyBignumStepLP : if (_trace) printf("DoMultiplyBignumStepLP:\n");

DoMultiplyBignumStepFP : if (_trace) printf("DoMultiplyBignumStepFP:\n");
...
multbignumsteplose : if (_trace) printf("multbignumsteplose:\n");
arg5 = 0;
arg2 = 80;
goto illegaloperand;
...
dodividebignumstep : if (_trace) printf("dodividebignumstep:\n");
...
DoDivideBignumStepLP : if (_trace) printf("DoDivideBignumStepLP:\n");

DoDivideBignumStepFP : if (_trace) printf("DoDivideBignumStepFP:\n");
...
divbignumsteplose2 : if (_trace) printf("divbignumsteplose2:\n");
arg5 = 0;
arg2 = 2;
goto illegaloperand;
...
dolshcbignumstep : if (_trace) printf("dolshcbignumstep:\n");
/* arg2 has the preloaded 8 bit operand. */

DoLshcBignumStepIM : if (_trace) printf("DoLshcBignumStepIM:\n");
...
DoLshcBignumStepLP : if (_trace) printf("DoLshcBignumStepLP:\n");

DoLshcBignumStepFP : if (_trace) printf("DoLshcBignumStepFP:\n");
