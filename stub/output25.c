...
vma_memory_read46475 : t5 = *(u64 *)&(processor->stackcachebasevma); // Base of stack cache
t7 = arg1 + ivory;
...
vma_memory_read46499 : t6 = *(u64 *)&(processor->stackcachebasevma); // Base of stack cache
t8 = t1 + ivory;
