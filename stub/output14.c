...
doephemeralp : if (_trace) printf("doephemeralp:\n");
/* arg2 has the preloaded 8 bit operand. */

DoEphemeralpIM : if (_trace) printf("DoEphemeralpIM:\n");
...
DoEphemeralpLP : if (_trace) printf("DoEphemeralpLP:\n");

DoEphemeralpFP : if (_trace) printf("DoEphemeralpFP:\n");
...
dounsignedlessp : if (_trace) printf("dounsignedlessp:\n");

DoUnsignedLesspSP : if (_trace) printf("DoUnsignedLesspSP:\n");
arg1 = arg5; // Assume SP mode
if (arg2 == 0) // SP-pop mode
    arg1 = iSP;
if (arg2 == 0) // Adjust SP if SP-pop mode
...
DoUnsignedLesspLP : if (_trace) printf("DoUnsignedLesspLP:\n");

DoUnsignedLesspFP : if (_trace) printf("DoUnsignedLesspFP:\n");
...
doallocatelistblock : if (_trace) printf("doallocatelistblock:\n");
...
DoAllocateListBlockLP : if (_trace) printf("DoAllocateListBlockLP:\n");

DoAllocateListBlockFP : if (_trace) printf("DoAllocateListBlockFP:\n");
...
i_allocate_block45654 : if (_trace) printf("i_allocate_block45654:\n");
/* SetTag. */
t1 = arg2 << 32;
t1 = arg1 | t1;
arg3 = 0; // arg3 = stackp
...
doallocatestructureblock : if (_trace) printf("doallocatestructureblock:\n");
...
DoAllocateStructureBlockLP : if (_trace) printf("DoAllocateStructureBlockLP:\n");

DoAllocateStructureBlockFP : if (_trace) printf("DoAllocateStructureBlockFP:\n");
...
i_allocate_block45656 : if (_trace) printf("i_allocate_block45656:\n");
/* SetTag. */
t1 = arg2 << 32;
t1 = arg1 | t1;
arg3 = 0; // arg3 = stackp
...
dopointerdifference : if (_trace) printf("dopointerdifference:\n");

DoPointerDifferenceSP : if (_trace) printf("DoPointerDifferenceSP:\n");
arg1 = arg5; // Assume SP mode
if (arg2 == 0) // SP-pop mode
    arg1 = iSP;
if (arg2 == 0) // Adjust SP if SP-pop mode
...
DoPointerDifferenceLP : if (_trace) printf("DoPointerDifferenceLP:\n");

DoPointerDifferenceFP : if (_trace) printf("DoPointerDifferenceFP:\n");
...
dopointerincrement : if (_trace) printf("dopointerincrement:\n");

DoPointerIncrementSP : if (_trace) printf("DoPointerIncrementSP:\n");
arg1 = arg5; // Assume SP mode
if (arg2 == 0) // SP-pop mode
    arg1 = iSP;
if (arg2 == 0) // Adjust SP if SP-pop mode
...
DoPointerIncrementLP : if (_trace) printf("DoPointerIncrementLP:\n");

DoPointerIncrementFP : if (_trace) printf("DoPointerIncrementFP:\n");
...
dostoreconditional : if (_trace) printf("dostoreconditional:\n");
/* arg2 has the preloaded 8 bit operand. */

DoStoreConditionalIM : if (_trace) printf("DoStoreConditionalIM:\n");
/* This sequence only sucks a moderate amount */
arg2 = arg2 << 56; // sign extend the byte argument.
...
DoStoreConditionalLP : if (_trace) printf("DoStoreConditionalLP:\n");

DoStoreConditionalFP : if (_trace) printf("DoStoreConditionalFP:\n");
...
storecondiop : if (_trace) printf("storecondiop:\n");
arg5 = 0;
arg2 = 65;
goto illegaloperand;
...
domemorywrite : if (_trace) printf("domemorywrite:\n");
/* arg2 has the preloaded 8 bit operand. */

DoMemoryWriteIM : if (_trace) printf("DoMemoryWriteIM:\n");
/* This sequence only sucks a moderate amount */
arg2 = arg2 << 56; // sign extend the byte argument.
...
DoMemoryWriteLP : if (_trace) printf("DoMemoryWriteLP:\n");

DoMemoryWriteFP : if (_trace) printf("DoMemoryWriteFP:\n");
...
dopstorecontents : if (_trace) printf("dopstorecontents:\n");
/* arg2 has the preloaded 8 bit operand. */

DoPStoreContentsIM : if (_trace) printf("DoPStoreContentsIM:\n");
/* This sequence only sucks a moderate amount */
arg2 = arg2 << 56; // sign extend the byte argument.
...
DoPStoreContentsLP : if (_trace) printf("DoPStoreContentsLP:\n");

DoPStoreContentsFP : if (_trace) printf("DoPStoreContentsFP:\n");
...
dosetcdrcode1 : if (_trace) printf("dosetcdrcode1:\n");

DoSetCdrCode1SP : if (_trace) printf("DoSetCdrCode1SP:\n");
arg1 = arg5; // Assume SP mode
if (arg2 == 0) // SP-pop mode
    arg1 = iSP;
if (arg2 == 0) // Adjust SP if SP-pop mode
...
DoSetCdrCode1LP : if (_trace) printf("DoSetCdrCode1LP:\n");

DoSetCdrCode1FP : if (_trace) printf("DoSetCdrCode1FP:\n");
...
dosetcdrcode2 : if (_trace) printf("dosetcdrcode2:\n");

DoSetCdrCode2SP : if (_trace) printf("DoSetCdrCode2SP:\n");
arg1 = arg5; // Assume SP mode
if (arg2 == 0) // SP-pop mode
    arg1 = iSP;
if (arg2 == 0) // Adjust SP if SP-pop mode
...
DoSetCdrCode2LP : if (_trace) printf("DoSetCdrCode2LP:\n");

DoSetCdrCode2FP : if (_trace) printf("DoSetCdrCode2FP:\n");
...
dojump : if (_trace) printf("dojump:\n");

DoJumpSP : if (_trace) printf("DoJumpSP:\n");
arg1 = arg5; // Assume SP mode
if (arg2 == 0) // SP-pop mode
    arg1 = iSP;
if (arg2 == 0) // Adjust SP if SP-pop mode
...
DoJumpLP : if (_trace) printf("DoJumpLP:\n");

DoJumpFP : if (_trace) printf("DoJumpFP:\n");
...
DoCheckPreemptRequestIM : if (_trace) printf("DoCheckPreemptRequestIM:\n");
...
dohalt : if (_trace) printf("dohalt:\n");
/* Actually only one entry point, but simulate others for dispatch */

DoHaltIM : if (_trace) printf("DoHaltIM:\n");
...
haltexc : if (_trace) printf("haltexc:\n");
arg3 = 1; // arg3 = stackp
arg1 = 0; // arg1 = instruction arity
arg4 = 0; // arg4 = arithmeticp
goto exception;
...
donoop : if (_trace) printf("donoop:\n");
/* Actually only one entry point, but simulate others for dispatch */

DoNoOpIM : if (_trace) printf("DoNoOpIM:\n");
...
doalu : if (_trace) printf("doalu:\n");
/* arg2 has the preloaded 8 bit operand. */

DoAluIM : if (_trace) printf("DoAluIM:\n");
/* This sequence only sucks a moderate amount */
arg2 = arg2 << 56; // sign extend the byte argument.
...
DoAluLP : if (_trace) printf("DoAluLP:\n");

DoAluFP : if (_trace) printf("DoAluFP:\n");
...
force_alignment45711 : if (_trace) printf("force_alignment45711:\n");
if (t1 != 0)
    goto basic_dispatch45693;

basic_dispatch45694 : if (_trace) printf("basic_dispatch45694:\n");
t1 = (t10 == Boole_And) ? 1 : 0;

force_alignment45712 : if (_trace) printf("force_alignment45712:\n");
if (t1 == 0)
...
basic_dispatch45695 : if (_trace) printf("basic_dispatch45695:\n");
t1 = (t10 == Boole_AndC1) ? 1 : 0;

force_alignment45713 : if (_trace) printf("force_alignment45713:\n");
if (t1 == 0)
...
basic_dispatch45696 : if (_trace) printf("basic_dispatch45696:\n");
t1 = (t10 == Boole_2) ? 1 : 0;

force_alignment45714 : if (_trace) printf("force_alignment45714:\n");
if (t1 == 0)
...
basic_dispatch45697 : if (_trace) printf("basic_dispatch45697:\n");
t1 = (t10 == Boole_AndC2) ? 1 : 0;

force_alignment45715 : if (_trace) printf("force_alignment45715:\n");
if (t1 == 0)
...
basic_dispatch45698 : if (_trace) printf("basic_dispatch45698:\n");
t1 = (t10 == Boole_1) ? 1 : 0;

force_alignment45716 : if (_trace) printf("force_alignment45716:\n");
if (t1 == 0)
...
basic_dispatch45699 : if (_trace) printf("basic_dispatch45699:\n");
t1 = (t10 == Boole_Xor) ? 1 : 0;

force_alignment45717 : if (_trace) printf("force_alignment45717:\n");
if (t1 == 0)
...
basic_dispatch45700 : if (_trace) printf("basic_dispatch45700:\n");
t1 = (t10 == Boole_Ior) ? 1 : 0;

force_alignment45718 : if (_trace) printf("force_alignment45718:\n");
if (t1 == 0)
...
basic_dispatch45701 : if (_trace) printf("basic_dispatch45701:\n");
t1 = (t10 == Boole_Nor) ? 1 : 0;

force_alignment45719 : if (_trace) printf("force_alignment45719:\n");
if (t1 == 0)
...
basic_dispatch45702 : if (_trace) printf("basic_dispatch45702:\n");
t1 = (t10 == Boole_Equiv) ? 1 : 0;

force_alignment45720 : if (_trace) printf("force_alignment45720:\n");
if (t1 == 0)
...
basic_dispatch45703 : if (_trace) printf("basic_dispatch45703:\n");
t1 = (t10 == Boole_C1) ? 1 : 0;

force_alignment45721 : if (_trace) printf("force_alignment45721:\n");
if (t1 == 0)
...
basic_dispatch45704 : if (_trace) printf("basic_dispatch45704:\n");
t1 = (t10 == Boole_OrC1) ? 1 : 0;

force_alignment45722 : if (_trace) printf("force_alignment45722:\n");
if (t1 == 0)
...
basic_dispatch45705 : if (_trace) printf("basic_dispatch45705:\n");
t1 = (t10 == Boole_C2) ? 1 : 0;

force_alignment45723 : if (_trace) printf("force_alignment45723:\n");
if (t1 == 0)
...
basic_dispatch45706 : if (_trace) printf("basic_dispatch45706:\n");
t1 = (t10 == Boole_OrC2) ? 1 : 0;

force_alignment45724 : if (_trace) printf("force_alignment45724:\n");
if (t1 == 0)
...
basic_dispatch45707 : if (_trace) printf("basic_dispatch45707:\n");
t1 = (t10 == Boole_Nand) ? 1 : 0;

force_alignment45725 : if (_trace) printf("force_alignment45725:\n");
if (t1 == 0)
...
basic_dispatch45708 : if (_trace) printf("basic_dispatch45708:\n");
t1 = (t10 == Boole_Set) ? 1 : 0;

force_alignment45726 : if (_trace) printf("force_alignment45726:\n");
if (t1 == 0)
    goto basic_dispatch45693;
...
force_alignment45752 : if (_trace) printf("force_alignment45752:\n");
if (t1 == 0)
...
force_alignment45734 : if (_trace) printf("force_alignment45734:\n");
if (t4 == 0)
    goto basic_dispatch45730;
/* Here if argument ALUByteBackgroundOp1 */
t1 = arg4;

basic_dispatch45729 : if (_trace) printf("basic_dispatch45729:\n");
t5 = arg6 >> 12;
...
force_alignment45739 : if (_trace) printf("force_alignment45739:\n");
if (t3 == 0)
    goto basic_dispatch45736;
/* Here if argument ALUByteFunctionDpb */
t5 = t5 << (t2 & 63); // Position mask

basic_dispatch45735 : if (_trace) printf("basic_dispatch45735:\n");
...
force_alignment45753 : if (_trace) printf("force_alignment45753:\n");
if (t1 == 0)
...
force_alignment45748 : if (_trace) printf("force_alignment45748:\n");
if (t4 == 0)
    goto basic_dispatch45743;
/* Here if argument ALUAdderOp2Op2 */
t1 = arg1;

basic_dispatch45742 : if (_trace) printf("basic_dispatch45742:\n");
t10 = arg4 + t1;
t10 = t10 + t2;
t3 = t10 >> 31; // Sign bit
t4 = t10 >> 32; // Next bit
...
force_alignment45754 : if (_trace) printf("force_alignment45754:\n");
if (t1 == 0)
...
basic_dispatch45743 : if (_trace) printf("basic_dispatch45743:\n");
t4 = (t3 == ALUAdderOp2_Zero) ? 1 : 0;

force_alignment45755 : if (_trace) printf("force_alignment45755:\n");
if (t4 == 0)
...
basic_dispatch45744 : if (_trace) printf("basic_dispatch45744:\n");
t4 = (t3 == ALUAdderOp2_Invert) ? 1 : 0;

force_alignment45756 : if (_trace) printf("force_alignment45756:\n");
if (t4 == 0)
...
force_alignment45757 : if (_trace) printf("force_alignment45757:\n");
if (t4 == 0)
    goto basic_dispatch45742;
...
force_alignment45758 : if (_trace) printf("force_alignment45758:\n");
if (t3 != 0)
    goto basic_dispatch45735;
goto basic_dispatch45735;

basic_dispatch45730 : if (_trace) printf("basic_dispatch45730:\n");
t4 = (t1 == ALUByteBackground_RotateLatch) ? 1 : 0;

force_alignment45759 : if (_trace) printf("force_alignment45759:\n");
if (t4 == 0)
...
force_alignment45760 : if (_trace) printf("force_alignment45760:\n");
if (t4 == 0)
    goto basic_dispatch45729;
...
dospareop : if (_trace) printf("dospareop:\n");
/* Actually only one entry point, but simulate others for dispatch */

DoSpareOpIM : if (_trace) printf("DoSpareOpIM:\n");
...
ReadRegisterError : if (_trace) printf("ReadRegisterError:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;
...
WriteRegisterFP : if (_trace) printf("WriteRegisterFP:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;
...
WriteRegisterLP : if (_trace) printf("WriteRegisterLP:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;
...
WriteRegisterSP : if (_trace) printf("WriteRegisterSP:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;
...
WriteRegisterStackCacheLowerBound : if (_trace) printf("WriteRegisterStackCacheLowerBound:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;
...
WriteRegisterFPCoprocessorPresent : if (_trace) printf("WriteRegisterFPCoprocessorPresent:\n");
goto NEXTINSTRUCTION;
...
WriteRegisterTOS : if (_trace) printf("WriteRegisterTOS:\n");
goto NEXTINSTRUCTION;
...
WriteRegisterMappingTableCache : if (_trace) printf("WriteRegisterMappingTableCache:\n");
goto NEXTINSTRUCTION;

/* end WriteRegisterMappingTableCache */
/* start WriteRegisterError */

WriteRegisterError : if (_trace) printf("WriteRegisterError:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;
...
docoprocessorread : if (_trace) printf("docoprocessorread:\n");
/* Actually only one entry point, but simulate others for dispatch */

DoCoprocessorReadIM : if (_trace) printf("DoCoprocessorReadIM:\n");
...
docoprocessorwrite : if (_trace) printf("docoprocessorwrite:\n");
/* Actually only one entry point, but simulate others for dispatch */

DoCoprocessorWriteIM : if (_trace) printf("DoCoprocessorWriteIM:\n");
...
mondo_dispatch45764 : if (_trace) printf("mondo_dispatch45764:\n");
...
mondo_dispatch45765 : if (_trace) printf("mondo_dispatch45765:\n");
...
mondo_dispatch45767 : if (_trace) printf("mondo_dispatch45767:\n");

mondo_dispatch45762 : if (_trace) printf("mondo_dispatch45762:\n");
goto NEXTINSTRUCTION;

unwindillegalcontinuation : if (_trace) printf("unwindillegalcontinuation:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;

unwindillegalcontrol : if (_trace) printf("unwindillegalcontrol:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;

unwindillegalfp : if (_trace) printf("unwindillegalfp:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;

unwindillegallp : if (_trace) printf("unwindillegallp:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;

cpwriteexc : if (_trace) printf("cpwriteexc:\n");
arg5 = 0;
arg2 = 84;
goto illegaloperand;
...
getrpcc : if (_trace) printf("getrpcc:\n");
r0 = RPCC();
arg1 = r0 << 32;
arg1 = r0 + arg1;
r0 = arg1 >> 32;
...
spinwheels : if (_trace) printf("spinwheels:\n");
arg1 = 1;
arg1 = arg1 << 25;
