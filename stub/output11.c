...
vma_memory_read45251 : t1 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t3 = arg4 + ivory;
t2 = *(int32_t *)&processor->scovlimit;
arg6 = (t3 * 4);
arg5 = LDQ_U(t3);
t1 = arg4 - t1; // Stack cache offset
t4 = *(uint64_t *)&(processor->header_mask);
t2 = ((uint64_t) t1 < (uint64_t) t2) ? 1 : 0; // In range?
arg6 = *(int32_t *)arg6;
arg5 = (uint8_t) (arg5 >> ((t3 & 7) * 8));
if (t2 != 0)
...
if (t2 & 1)
    goto aref1exception;
*(uint32_t *)&((ARRAYCACHEP)t7)->array = t12; // store the array
t2 = zero + Array_LengthMask;
t1 = arg6 & t2;
t2 = ((uint64_t) arg2 < (uint64_t) t1) ? 1 : 0;
if (t2 == 0)
    goto aref1bounds;
*(uint64_t *)&((ARRAYCACHEP)t7)->length = t1; // store the array length [implicit fixnum]
t10 = arg6 >> (Array_RegisterBytePackingPos & 63);
t8 = *(uint64_t *)&(processor->areventcount);
t10 = t10 << (Array_RegisterBytePackingPos & 63);
t9 = arg4 + 1;
t10 = t10 + t8; // Construct the array register word
*(uint32_t *)&((ARRAYCACHEP)t7)->arword = t10; // store the array register word [implicit fixnum]
*(uint64_t *)&((ARRAYCACHEP)t7)->locat = t9; // store the storage [implicit locative]
...
t4 = *(int32_t *)t3; // Get the memory action
...
vma_memory_read45264 : t8 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t3 = t5 + ivory;
t2 = *(int32_t *)&processor->scovlimit;
t6 = (t3 * 4);
t7 = LDQ_U(t3);
t8 = t5 - t8; // Stack cache offset
t1 = *(uint64_t *)&(processor->header_mask);
t2 = ((uint64_t) t8 < (uint64_t) t2) ? 1 : 0; // In range?
t6 = *(int32_t *)t6;
t7 = (uint8_t) (t7 >> ((t3 & 7) * 8));
if (t2 != 0)
...
*(uint64_t *)&processor->asrf5 = arg1; // Just a place to save these values
*(uint64_t *)&processor->asrf4 = t10; // Just a place to save these values
*(uint64_t *)&processor->asrf3 = t11; // Just a place to save these values
*(uint64_t *)&processor->asrf6 = arg1; // Just a place to save these values
*(uint64_t *)&processor->asrf7 = arg2; // Just a place to save these values
*(uint64_t *)&processor->asrf8 = arg3; // Just a place to save these values
*(uint64_t *)&processor->asrf9 = arg4; // Just a place to save these values
t9 = *(int32_t *)(arg1 + -8);
arg2 = *(int32_t *)(arg1 + -4);
t9 = (uint32_t) t9;
arg1 = t5;
...
t2 = 1;
iSP = iSP + 24;
r0 = (uint64_t)  && return0068;
goto setup1dlongarray;
return0068 : t4 = (t2 == ReturnValue_Exception) ? 1 : 0;
if (t4 != 0)
    goto recompute_array_register45262;
arg1 = *(uint64_t *)&(processor->asrf5); // Just a place to save these values
t10 = *(uint64_t *)&(processor->asrf4); // Just a place to save these values
t11 = *(uint64_t *)&(processor->asrf3); // Just a place to save these values
arg1 = *(uint64_t *)&(processor->asrf6); // Just a place to save these values
arg2 = *(uint64_t *)&(processor->asrf7); // Just a place to save these values
arg3 = *(uint64_t *)&(processor->asrf8); // Just a place to save these values
arg4 = *(uint64_t *)&(processor->asrf9); // Just a place to save these values
t3 = *(uint64_t *)iSP;
iSP = iSP - 8; // Pop Stack.
t2 = *(uint64_t *)iSP;
iSP = iSP - 8; // Pop Stack.
...
t5 = (uint32_t) t6; // Do the indirect thing
goto vma_memory_read45264;

vma_memory_read45267 : if (_trace) printf("vma_memory_read45267:\n");
t1 = *(uint64_t *)&(processor->header); // Load the memory action table for cycle
/* TagType. */
...
*(uint64_t *)&processor->asrf4 = arg2; // Just a place to save these values
*(uint64_t *)&processor->asrf5 = t7; // Just a place to save these values
t9 = t12;
arg2 = arg3;
arg1 = arg4;
t4 = arg5;
...
t2 = zero;
iSP = iSP + 24;
r0 = (uint64_t)  && return0069;
goto setup1dlongarray;
return0069 : arg2 = *(int32_t *)&processor->asrf4; // Just a place to save these values
t7 = *(uint64_t *)&(processor->asrf5); // Just a place to save these values
t1 = *(int32_t *)iSP; // Length
t5 = *(int32_t *)(iSP + 4); // Length
iSP = iSP - 8; // Pop Stack.
t1 = (uint32_t) t1;
t5 = *(uint64_t *)iSP; // base
iSP = iSP - 8; // Pop Stack.
t3 = *(uint64_t *)iSP; // control
iSP = iSP - 8; // Pop Stack.
t9 = *(int32_t *)iSP; // The original array
arg3 = *(int32_t *)(iSP + 4); // The original array
iSP = iSP - 8; // Pop Stack.
t9 = (uint32_t) t9;
iSP = iSP - 24;
*(uint64_t *)&((ARRAYCACHEP)t7)->length = t1;
*(uint32_t *)&((ARRAYCACHEP)t7)->arword = t3;
*(uint32_t *)&((ARRAYCACHEP)t7)->locat = t5;
*(uint32_t *)&((ARRAYCACHEP)t7)->array = t9; // store the array
t9 = (uint32_t) t5;
t2 = (t2 == ReturnValue_Exception) ? 1 : 0;
if (t2 != 0)
    goto reallyaref1exc;
t5 = ((uint64_t) arg2 < (uint64_t) t1) ? 1 : 0;
if (t5 == 0)
    goto aref1bounds;
...
*(uint64_t *)&((ARRAYCACHEP)t7)->array = zero;
arg5 = 0;
arg2 = 74;
goto illegaloperand;
...
vma_memory_read45274 : t1 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t3 = arg4 + ivory;
t2 = *(int32_t *)&processor->scovlimit;
arg6 = (t3 * 4);
arg5 = LDQ_U(t3);
...
vma_memory_read45287 : t8 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t3 = t5 + ivory;
t2 = *(int32_t *)&processor->scovlimit;
t6 = (t3 * 4);
t7 = LDQ_U(t3);
...
*(uint64_t *)&processor->asrf4 = arg2; // Just a place to save these values
*(uint64_t *)&processor->asrf3 = t5; // Just a place to save these values
*(uint64_t *)&processor->asrf6 = t6; // Just a place to save these values
*(uint64_t *)&processor->asrf5 = t7; // Just a place to save these values
t9 = t12;
arg2 = arg3;
arg1 = arg4;
...
t2 = zero;
iSP = iSP + 24;
r0 = (uint64_t)  && return0071;
goto setup1dlongarray;
return0071 : t1 = (t2 == ReturnValue_Exception) ? 1 : 0;
if (t1 != 0)
    goto reallyaset1exc;
arg2 = *(int32_t *)&processor->asrf4; // Just a place to save these values
t5 = *(uint64_t *)&(processor->asrf3); // Just a place to save these values
t6 = *(uint64_t *)&(processor->asrf6); // Just a place to save these values
t7 = *(uint64_t *)&(processor->asrf5); // Just a place to save these values
t1 = *(int32_t *)iSP; // Length
t2 = *(int32_t *)(iSP + 4); // Length
iSP = iSP - 8; // Pop Stack.
t1 = (uint32_t) t1;
t2 = *(uint64_t *)iSP; // base
iSP = iSP - 8; // Pop Stack.
t3 = *(uint64_t *)iSP; // control
iSP = iSP - 8; // Pop Stack.
t9 = *(int32_t *)iSP; // The original array
...
*(uint64_t *)&((ARRAYCACHEP)t7)->length = t1;
*(uint32_t *)&((ARRAYCACHEP)t7)->arword = t3;
*(uint32_t *)&((ARRAYCACHEP)t7)->locat = t2;
*(uint32_t *)&((ARRAYCACHEP)t7)->array = t9; // store the array
t9 = (uint32_t) t2;
t2 = ((uint64_t) arg2 < (uint64_t) t1) ? 1 : 0;
if (t2 == 0)
...
arg3 = *(int32_t *)(iSP + 4); // Get the array tag/data
iSP = iSP - 8; // Pop Stack.
arg4 = (uint32_t) arg4;
arg2 = (uint32_t) arg1; // Index Data
...
vma_memory_read45297 : t1 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t3 = arg4 + ivory;
t2 = *(int32_t *)&processor->scovlimit;
arg6 = (t3 * 4);
arg5 = LDQ_U(t3);
...
t2 = zero + Array_LengthMask;
t1 = arg6 & t2;
t3 = ((uint64_t) arg2 < (uint64_t) t1) ? 1 : 0;
if (t3 == 0)
    goto aloc1illegal;
arg6 = arg6 >> (Array_ElementTypePos & 63); // get element type into arg6
arg4 = arg4 + 1;
...
arg1 = (uint32_t) arg1; // and the data
...
vma_memory_read45310 : t5 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t7 = arg1 + ivory;
...
t7 = Type_Fixnum;
t1 = *(uint64_t *)&(processor->areventcount);
...
vma_memory_read45324 : t5 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t7 = arg1 + ivory;
t6 = *(int32_t *)&processor->scovlimit;
t3 = (t7 * 4);
t4 = LDQ_U(t7);
...
vma_memory_read45344 : t7 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t10 = t1 + ivory;
t8 = *(int32_t *)&processor->scovlimit;
arg4 = (t10 * 4);
t6 = LDQ_U(t10);
t7 = t1 - t7; // Stack cache offset
t11 = *(uint64_t *)&(processor->dataread_mask);
t8 = ((uint64_t) t7 < (uint64_t) t8) ? 1 : 0; // In range?
arg4 = *(int32_t *)arg4;
t6 = (uint8_t) (t6 >> ((t10 & 7) * 8));
if (t8 != 0)
...
vma_memory_read45356 : t7 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t10 = t1 + ivory;
t8 = *(int32_t *)&processor->scovlimit;
arg3 = (t10 * 4);
t6 = LDQ_U(t10);
...
vma_memory_read45368 : t7 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t10 = t1 + ivory;
t8 = *(int32_t *)&processor->scovlimit;
t5 = (t10 * 4);
t6 = LDQ_U(t10);
...
*(uint32_t *)(iSP + 8) = t9;
*(uint32_t *)(iSP + 12) = t10; // write the stack cache
iSP = iSP + 8;
...
vma_memory_read45384 : t7 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t10 = t5 + ivory;
t8 = *(int32_t *)&processor->scovlimit;
t4 = (t10 * 4);
t6 = LDQ_U(t10);
t7 = t5 - t7; // Stack cache offset
t11 = *(uint64_t *)&(processor->header_mask);
t8 = ((uint64_t) t7 < (uint64_t) t8) ? 1 : 0; // In range?
t4 = *(int32_t *)t4;
t6 = (uint8_t) (t6 >> ((t10 & 7) * 8));
if (t8 != 0)
...
vma_memory_read45394 : t7 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t10 = t1 + ivory;
t8 = *(int32_t *)&processor->scovlimit;
arg6 = (t10 * 4);
t4 = LDQ_U(t10);
...
vma_memory_read45406 : t7 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t10 = t1 + ivory;
t8 = *(int32_t *)&processor->scovlimit;
arg5 = (t10 * 4);
t4 = LDQ_U(t10);
...
vma_memory_read45418 : t7 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t10 = t1 + ivory;
t8 = *(int32_t *)&processor->scovlimit;
t5 = (t10 * 4);
t4 = LDQ_U(t10);
...
t5 = *(int32_t *)t7;
t4 = *(int32_t *)(t7 + 4); // Read from stack cache
...
t11 = *(uint64_t *)&(processor->dataread); // Load the memory action table for cycle
/* TagType. */
...
t1 = (uint32_t) arg5; // Do the indirect thing
...
t1 = (uint32_t) arg6; // Do the indirect thing
...
t1 = (uint32_t) arg3; // Do the indirect thing
...
t1 = (uint32_t) arg4; // Do the indirect thing
...
arg1 = (arg2 * 8) + arg1; // Compute operand address
arg4 = *(int32_t *)iSP; // Index
arg3 = *(int32_t *)(iSP + 4); // Index
iSP = iSP - 8; // Pop Stack.
arg4 = (uint32_t) arg4;
t11 = *(int32_t *)iSP; // value
t10 = *(int32_t *)(iSP + 4); // value
iSP = iSP - 8; // Pop Stack.
t11 = (uint32_t) t11;
t1 = arg3 - Type_Fixnum;
t1 = t1 & 63; // Strip CDR code
...
t4 = *(uint64_t *)&(processor->areventcount);
t5 = t5 >> 42;
t2 = ((uint64_t) arg4 < (uint64_t) t3) ? 1 : 0;
if (t2 == 0)
...
vma_memory_read45461 : t4 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t12 = t1 + ivory;
t5 = *(int32_t *)&processor->scovlimit;
t3 = (t12 * 4);
t2 = LDQ_U(t12);
t4 = t1 - t4; // Stack cache offset
arg3 = *(uint64_t *)&(processor->datawrite_mask);
t5 = ((uint64_t) t4 < (uint64_t) t5) ? 1 : 0; // In range?
t3 = *(int32_t *)t3;
t2 = (uint8_t) (t2 >> ((t12 & 7) * 8));
if (t5 != 0)
...
t4 = t1 + ivory;
arg3 = *(int32_t *)&processor->scovlimit;
t3 = (t4 * 4);
t12 = LDQ_U(t4);
t5 = t1 - t5; // Stack cache offset
arg3 = ((uint64_t) t5 < (uint64_t) arg3) ? 1 : 0; // In range?
t5 = (t2 & 0xff) << ((t4 & 7) * 8);
...
vma_memory_read45474 : t2 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t4 = t1 + ivory;
...
t2 = t1 + ivory;
t12 = *(int32_t *)&processor->scovlimit;
t5 = (t2 * 4);
t4 = LDQ_U(t2);
t3 = t1 - t3; // Stack cache offset
t12 = ((uint64_t) t3 < (uint64_t) t12) ? 1 : 0; // In range?
t3 = (arg5 & 0xff) << ((t2 & 7) * 8);
t4 = t4 & ~(0xffL << (t2 & 7) * 8);
...
*(uint32_t *)t2 = t11; // Store in stack
*(uint32_t *)(t2 + 4) = arg5; // write the stack cache
goto NEXTINSTRUCTION;
...
t9 = *(int32_t *)t2;
arg5 = *(int32_t *)(t2 + 4); // Read from stack cache
...
t5 = *(int32_t *)t4; // Get the memory action
...
*(uint32_t *)t4 = t11; // Store in stack
...
arg3 = *(uint64_t *)&(processor->datawrite); // Load the memory action table for cycle
/* TagType. */
t12 = t2 & 63; // Discard the CDR code
*(uint64_t *)&processor->vma = t1; // stash the VMA for the (likely) trap
t12 = (t12 * 4) + arg3; // Adjust for a longword load
arg3 = *(int32_t *)t12; // Get the memory action
...
/* arg1 has the operand, not sign extended if immediate. */
arg4 = *(int32_t *)iSP; // arg3=arraytag, arg4=arraydata
arg3 = *(int32_t *)(iSP + 4); // arg3=arraytag, arg4=arraydata
iSP = iSP - 8; // Pop Stack.
arg4 = (uint32_t) arg4;
arg2 = (uint32_t) arg1; // index data
arg1 = arg1 >> 32; // index tag
...
t4 = *(uint64_t *)&(processor->header_mask);
t2 = ((uint64_t) t1 < (uint64_t) t12) ? 1 : 0; // In range?
arg5 = *(int32_t *)arg5;
arg6 = (uint8_t) (arg6 >> ((t3 & 7) * 8));
if (t2 != 0)
...
t1 = ((uint64_t) arg2 < (uint64_t) t8) ? 1 : 0;
if (t1 == 0)
...
t4 = *(uint64_t *)&(processor->dataread_mask);
t2 = ((uint64_t) t1 < (uint64_t) t12) ? 1 : 0; // In range?
arg5 = *(int32_t *)arg5;
arg6 = (uint8_t) (arg6 >> ((t3 & 7) * 8));
if (t2 != 0)
...
arg4 = (uint32_t) arg5; // Do the indirect thing
...
iSP = iSP - 8; // Pop Stack.
arg4 = (uint32_t) arg4;
t7 = *(int32_t *)iSP; // t6=valuetag, t7=valuedata
t6 = *(int32_t *)(iSP + 4); // t6=valuetag, t7=valuedata
iSP = iSP - 8; // Pop Stack.
t7 = (uint32_t) t7;
arg2 = (uint32_t) arg1; // index data
arg1 = arg1 >> 32; // index tag
...
t1 = ((uint64_t) arg2 < (uint64_t) t2) ? 1 : 0;
if (t1 == 0)
...
t8 = ((uint64_t) t4 < (uint64_t) t12) ? 1 : 0; // In range?
t4 = (t1 & 0xff) << ((t3 & 7) * 8);
t5 = t5 & ~(0xffL << (t3 & 7) * 8);
...
*(uint32_t *)t3 = t7; // Store in stack
*(uint32_t *)(t3 + 4) = t1; // write the stack cache
goto NEXTINSTRUCTION;
...
t8 = *(int32_t *)t5; // Get the memory action
...
vma_memory_read45537 : t1 = *(uint64_t *)&(processor->stackcachebasevma); // Base of stack cache
t3 = arg4 + ivory;
t2 = *(int32_t *)&processor->scovlimit;
arg5 = (t3 * 4);
arg6 = LDQ_U(t3);
...
t1 = ((uint64_t) arg2 < (uint64_t) t9) ? 1 : 0;
if (t1 == 0)
