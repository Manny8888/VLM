...
g3709:
  if (_trace) printf("g3709:\n");

g3708:
  if (_trace) printf("g3708:\n");
  /* Cycle-number -> table offset */
  t8 = (arg3 * 4);
  t8 = (t8 * 4) + ivory;
