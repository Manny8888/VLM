...
enum KeyboardType { Unknown, DEC_LK401, DEC_PC, Apple_Pro };
...
static short fkmapDECLK[] = {
    ...
    /* F3-F5 are intercepted by DEC's window manager and, therefore, aren't
       usable in Genera */
    -1, -1, /* F3 */
    -1, -1, /* F4 */
    -1, -1, /* F5 */
    SK_Network, SK_Network, /* F6 */
    /* F7-F11 are intercepted by DEC's window manager and, therefore, aren't
       usable in Genera */
    -1, -1, /* F7 */
    -1, -1, /* F8 */
    -1, -1, /* F9 */
