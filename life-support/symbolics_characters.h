 ...
 *> ** Portions of font library Copyright (c) 1984 Bitstream, Inc.  All Rights
 *Reserved.
 *>
 ...
 *>
 *> Symbolics, Symbolics 3600, Symbolics 3670 (R), Symbolics 3675 (R),
 *Symbolics 3630, > Symbolics 3640, Symbolics 3645 (R), Symbolics 3650 (R),
 *Symbolics 3653, Symbolics > 3620 (R), Symbolics 3610 (R), Symbolics Common
 *Lisp (R), Symbolics-Lisp (R), > Zetalisp (R), Genera (R), Wheels (R),
 *Dynamic Windows (R), Showcase, SmartStore (R), > Semanticue (R), Frame-Up
 *(R), Firewall (R), MACSYMA (R), COMMON LISP MACSYMA (R), > CL-MACSYMA (R),
 *LISP MACHINE MACSYMA (R), MACSYMA Newsletter (R), PC-MACSYMA, Document >
 *Examiner (R), Delivery Document Examiner, S-DYNAMICS (R), S-GEOMETRY (R),
 *S-PAINT (R), > S-RECORD, S-RENDER (R), Displacement Animation, FrameThrower,
 *PaintAmation, "Your Next > Step in Computing" (R), Ivory, MacIvory, MacIvory
 *model 1, MacIvory model 2, MacIvory > model 3, XL400, XL1200, Symbolics
 *UX400S, Symbolics UX1200S, Symbolics C, Symbolics > Pascal (R), Symbolics
 *Prolog, Symbolics Fortran (R), CLOE (R), CLOE Application Generator, > CLOE
 *Developer, CLOE Runtime, Common Lisp Developer, Symbolics Concordia, Joshua,
 *and > Statice (R) are trademarks of Symbolics, Inc.
 *>
