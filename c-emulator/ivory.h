...
typedef enum _IvoryType {
    ...
    TypePackedInstruction63,
    TypePackedInstruction64,
    TypePackedInstruction65,
    TypePackedInstruction66,
    TypePackedInstruction67,
    TypePackedInstruction70,
    TypePackedInstruction71,
    TypePackedInstruction72,
    TypePackedInstruction73,
    TypePackedInstruction74,
    TypePackedInstruction75,
    TypePackedInstruction76,
