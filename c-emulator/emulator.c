...
static void io_handler(int number) { suspend = SuspendSpy; }

void SendInterruptToEmulator() { suspend = SuspendHighPriority; }
...
static void RecomputeArrayRegister(LispObj *areg, int count)
{
    ...
    case TypeArrayInstance:
    case TypeStringInstance:
        TakeInstructionExceptionTrap();
    default:
...
Integer ALUFunctionAdder(Integer ALU, Integer op1, Integer op2)
{
    ...
    case ALUAdderOp2Op2:
        break;
    case ALUAdderOp2Zero:
        op2 = 0;
    case ALUAdderOp2Invert:
        op2 = -op2;
    case ALUAdderOp2MinusOne:
        op2 = -1;
    }
...
int InstructionSequencer(void)
{
    ...
    vector = setjmp(trap_environment);
    if (vector) {
        DecacheRegisters();
        switch (vector) {
        /* Special "Spy" vector */
...
Dispatch:
    ...
    if (cp->code != DispatchInstructionCacheLookup) {
        ps->instruction_count++;
        if (Trace) {
            fprintf(stderr, "PC %08x(%s), SP: %08lx, TOS: %x.%02x.%08x, %s(%d)\n", cp->pc.DATA.u,
    ...
    case DispatchSetToCarSP:
        AddressSPOperand();
        goto ExecuteSetToCar;
    case DispatchSetToCarFP:
        AddressFPOperand();
        goto ExecuteSetToCar;
    case DispatchSetToCarLP:
        AddressLPOperand();
        goto ExecuteSetToCar;
    ExecuteSetToCar:
        MARK(SetToCar);
    ...
    case DispatchSetToCdrSP:
        AddressSPOperand();
        goto ExecuteSetToCdr;
    case DispatchSetToCdrFP:
        AddressFPOperand();
        goto ExecuteSetToCdr;
    case DispatchSetToCdrLP:
        AddressLPOperand();
        goto ExecuteSetToCdr;
    ExecuteSetToCdr:
        MARK(SetToCdr);
    ...
    case DispatchSetToCdrPushCarSP:
        AddressSPOperand();
        goto ExecuteSetToCdrPushCar;
    case DispatchSetToCdrPushCarFP:
        AddressFPOperand();
        goto ExecuteSetToCdrPushCar;
    case DispatchSetToCdrPushCarLP:
        AddressLPOperand();
        goto ExecuteSetToCdrPushCar;
    ...
    case DispatchRplacaImmediate:
        AddressImmediateOperand();
        goto ExecuteRplaca;
    case DispatchRplacaSP:
        AddressSPOperand();
        goto ExecuteRplaca;
    case DispatchRplacaFP:
        AddressFPOperand();
        goto ExecuteRplaca;
    case DispatchRplacaLP:
        AddressLPOperand();
        goto ExecuteRplaca;
    case DispatchRplacaPop:
        AddressPopOperand();
        goto ExecuteRplaca;
    ExecuteRplaca:
        MARK(Rplaca);
    ...
    case DispatchRplacdImmediate:
        AddressImmediateOperand();
        goto ExecuteRplacd;
    case DispatchRplacdSP:
        AddressSPOperand();
        goto ExecuteRplacd;
    case DispatchRplacdFP:
        AddressFPOperand();
        goto ExecuteRplacd;
    case DispatchRplacdLP:
        AddressLPOperand();
        goto ExecuteRplacd;
    case DispatchRplacdPop:
        AddressPopOperand();
        goto ExecuteRplacd;
    ExecuteRplacd:
        MARK(Rplacd);
    ...
    case DispatchRgetfSP:
        AddressSPOperand();
        goto ExecuteRgetf;
    case DispatchRgetfFP:
        AddressFPOperand();
        goto ExecuteRgetf;
    case DispatchRgetfLP:
        AddressLPOperand();
        goto ExecuteRgetf;
    case DispatchRgetfPop:
        AddressPopOperand();
        goto ExecuteRgetf;
    ExecuteRgetf:
        MARK(Rgetf);
    ...
    case DispatchMemberSP:
        AddressSPOperand();
        goto ExecuteMember;
    case DispatchMemberFP:
        AddressFPOperand();
        goto ExecuteMember;
    case DispatchMemberLP:
        AddressLPOperand();
        goto ExecuteMember;
    case DispatchMemberPop:
        AddressPopOperand();
        goto ExecuteMember;
    ExecuteMember:
        MARK(Member);
    ...
    case DispatchAssocSP:
        AddressSPOperand();
        goto ExecuteAssoc;
    case DispatchAssocFP:
        AddressFPOperand();
        goto ExecuteAssoc;
    case DispatchAssocLP:
        AddressLPOperand();
        goto ExecuteAssoc;
    case DispatchAssocPop:
        AddressPopOperand();
        goto ExecuteAssoc;
    ExecuteAssoc:
        MARK(Assoc);
    ...
    case DispatchEqNoPopImmediate:
        ...
        NextInstruction;
    case DispatchEqNoPopSP:
        AddressSPOperand();
        goto ExecuteEqNoPop;
    case DispatchEqNoPopFP:
        AddressFPOperand();
        goto ExecuteEqNoPop;
    case DispatchEqNoPopLP:
        AddressLPOperand();
        goto ExecuteEqNoPop;
    case DispatchEqNoPopPop:
        AddressPopOperand();
        goto ExecuteEqNoPop;
    ExecuteEqNoPop:
        MARK(EqNoPop);
    ...
    case DispatchEqlNoPopImmediate:
        PushPredicate(TypeFixnumP(sp->TAG) && (sp->DATA.s == cp->operand));
        NextInstruction;
    case DispatchEqlNoPopSP:
        AddressSPOperand();
        goto ExecuteEqlNoPop;
    case DispatchEqlNoPopFP:
        AddressFPOperand();
        goto ExecuteEqlNoPop;
    case DispatchEqlNoPopLP:
        AddressLPOperand();
        goto ExecuteEqlNoPop;
    case DispatchEqlNoPopPop:
        AddressPopOperand();
        goto ExecuteEqlNoPop;
    ExecuteEqlNoPop:
        MARK(EqlNoPop);
    ...
    case DispatchEqualNumberImmediate:
        SetPredicate(TypeFixnumP(sp->TAG) && (sp->DATA.s == cp->operand));
        NextInstruction;
    case DispatchEqualNumberSP:
        AddressSPOperand();
        goto ExecuteEqualNumber;
    case DispatchEqualNumberFP:
        AddressFPOperand();
        goto ExecuteEqualNumber;
    case DispatchEqualNumberLP:
        AddressLPOperand();
        goto ExecuteEqualNumber;
    case DispatchEqualNumberPop:
        AddressPopOperand();
        goto ExecuteEqualNumber;
    ExecuteEqualNumber:
        MARK(EqualNumber);
    ...
    case DispatchEqualNumberNoPopImmediate:
        PushPredicate(TypeFixnumP(sp->TAG) && (sp->DATA.s == cp->operand));
        NextInstruction;
    case DispatchEqualNumberNoPopSP:
        AddressSPOperand();
        goto ExecuteEqualNumberNoPop;
    case DispatchEqualNumberNoPopFP:
        AddressFPOperand();
        goto ExecuteEqualNumberNoPop;
    case DispatchEqualNumberNoPopLP:
        AddressLPOperand();
        goto ExecuteEqualNumberNoPop;
    case DispatchEqualNumberNoPopPop:
        AddressPopOperand();
        goto ExecuteEqualNumberNoPop;
    ...
    case DispatchGreaterpImmediate:
        AddressImmediateOperand();
        goto ExecuteGreaterp;
    case DispatchGreaterpSP:
        AddressSPOperand();
        goto ExecuteGreaterp;
    case DispatchGreaterpFP:
        AddressFPOperand();
        goto ExecuteGreaterp;
    case DispatchGreaterpLP:
        AddressLPOperand();
        goto ExecuteGreaterp;
    case DispatchGreaterpPop:
        AddressPopOperand();
        goto ExecuteGreaterp;
    ExecuteGreaterp:
        MARK(Greaterp);
    ...
    case DispatchGreaterpNoPopImmediate:
        AddressImmediateOperand();
        goto ExecuteGreaterpNoPop;
    case DispatchGreaterpNoPopSP:
        AddressSPOperand();
        goto ExecuteGreaterpNoPop;
    case DispatchGreaterpNoPopFP:
        AddressFPOperand();
        goto ExecuteGreaterpNoPop;
    case DispatchGreaterpNoPopLP:
        AddressLPOperand();
        goto ExecuteGreaterpNoPop;
    case DispatchGreaterpNoPopPop:
        AddressPopOperand();
        goto ExecuteGreaterpNoPop;
    ...
    case DispatchLesspImmediate:
        AddressImmediateOperand();
        goto ExecuteLessp;
    case DispatchLesspSP:
        AddressSPOperand();
        goto ExecuteLessp;
    case DispatchLesspFP:
        AddressFPOperand();
        goto ExecuteLessp;
    case DispatchLesspLP:
        AddressLPOperand();
        goto ExecuteLessp;
    case DispatchLesspPop:
        AddressPopOperand();
        goto ExecuteLessp;
    ExecuteLessp:
        MARK(Lessp);
    ...
    case DispatchLesspNoPopImmediate:
        AddressImmediateOperand();
        goto ExecuteLesspNoPop;
    case DispatchLesspNoPopSP:
        AddressSPOperand();
        goto ExecuteLesspNoPop;
    case DispatchLesspNoPopFP:
        AddressFPOperand();
        goto ExecuteLesspNoPop;
    case DispatchLesspNoPopLP:
        AddressLPOperand();
        goto ExecuteLesspNoPop;
    case DispatchLesspNoPopPop:
        AddressPopOperand();
        goto ExecuteLesspNoPop;
    ExecuteLesspNoPop:
        MARK(LesspNoPop);
    ...
    case DispatchLogtestImmediate:
        AddressImmediateOperand();
        goto ExecuteLogtest;
    case DispatchLogtestSP:
        AddressSPOperand();
        goto ExecuteLogtest;
    case DispatchLogtestFP:
        AddressFPOperand();
        goto ExecuteLogtest;
    case DispatchLogtestLP:
        AddressLPOperand();
        goto ExecuteLogtest;
    case DispatchLogtestPop:
        AddressPopOperand();
        goto ExecuteLogtest;
    ExecuteLogtest:
        MARK(Logtest);
    ...
    case DispatchLogtestNoPopImmediate:
        AddressImmediateOperand();
        goto ExecuteLogtestNoPop;
    case DispatchLogtestNoPopSP:
        AddressSPOperand();
        goto ExecuteLogtestNoPop;
    case DispatchLogtestNoPopFP:
        AddressFPOperand();
        goto ExecuteLogtestNoPop;
    case DispatchLogtestNoPopLP:
        AddressLPOperand();
        goto ExecuteLogtestNoPop;
    case DispatchLogtestNoPopPop:
        AddressPopOperand();
        goto ExecuteLogtestNoPop;
    ExecuteLogtestNoPop:
        MARK(LogtestNoPop);
    ...
    case DispatchTypeMember:
         ...
         */
        {
            ...
            SetPredicate((0 <= dtp) && (dtp <= 7) && ((1 << dtp) & mask));
            NextInstruction;
        }
    ...
    case DispatchTypeMemberNoPop:
         ...
         */
        {
            ...
            PushPredicate((0 <= dtp) && (dtp <= 7) && ((1 << dtp) & mask));
            NextInstruction;
        }
    ...
    case DispatchPluspImmediate:
        ...
        NextInstruction;
    case DispatchPluspSP:
        AddressSPOperand();
        goto ExecutePlusp;
    case DispatchPluspFP:
        AddressFPOperand();
        goto ExecutePlusp;
    case DispatchPluspLP:
        AddressLPOperand();
        goto ExecutePlusp;
    case DispatchPluspPop:
        AddressPopOperand();
        goto ExecutePlusp;
    ExecutePlusp:
        MARK(Plusp);
    ...
    case DispatchMinuspImmediate:
        PushPredicate(cp->operand < 0);
        NextInstruction;
    case DispatchMinuspSP:
        AddressSPOperand();
        goto ExecuteMinusp;
    case DispatchMinuspFP:
        AddressFPOperand();
        goto ExecuteMinusp;
    case DispatchMinuspLP:
        AddressLPOperand();
        goto ExecuteMinusp;
    case DispatchMinuspPop:
        AddressPopOperand();
        goto ExecuteMinusp;
    ExecuteMinusp:
        MARK(Minusp);
    ...
    case DispatchZeropImmediate:
        PushPredicate(cp->operand == 0);
        NextInstruction;
    case DispatchZeropSP:
        AddressSPOperand();
        goto ExecuteZerop;
    case DispatchZeropFP:
        AddressFPOperand();
        goto ExecuteZerop;
    case DispatchZeropLP:
        AddressLPOperand();
        goto ExecuteZerop;
    case DispatchZeropPop:
        AddressPopOperand();
        goto ExecuteZerop;
    ExecuteZerop:
        MARK(Zerop);
    ...
    case DispatchUnaryMinusImmediate:
        ...
        NextInstruction;
    case DispatchUnaryMinusSP:
        AddressSPOperand();
        goto ExecuteUnaryMinus;
    case DispatchUnaryMinusFP:
        AddressFPOperand();
        goto ExecuteUnaryMinus;
    case DispatchUnaryMinusLP:
        AddressLPOperand();
        goto ExecuteUnaryMinus;
    case DispatchUnaryMinusPop:
        AddressPopOperand();
        goto ExecuteUnaryMinus;
    ExecuteUnaryMinus:
        MARK(UnaryMinus);
        if (TypeFixnumP(op2->TAG) && op2->DATA.s != (-1 << 31)) {
    ...
    /* --- maybe handle single-floats */
    case DispatchIncrementSP:
        AddressSPOperand();
        goto ExecuteIncrement;
    case DispatchIncrementFP:
        AddressFPOperand();
        goto ExecuteIncrement;
    case DispatchIncrementLP:
        AddressLPOperand();
        goto ExecuteIncrement;
    ExecuteIncrement:
        MARK(Increment);
    ...
    /* --- maybe handle single-floats */
    case DispatchDecrementSP:
        AddressSPOperand();
        goto ExecuteDecrement;
    case DispatchDecrementFP:
        AddressFPOperand();
        goto ExecuteDecrement;
    case DispatchDecrementLP:
        AddressLPOperand();
        goto ExecuteDecrement;
    ExecuteDecrement:
        MARK(Decrement);
    ...
    case DispatchMultiplyImmediate:
        AddressImmediateOperand();
        goto ExecuteMultiply;
    case DispatchMultiplySP:
        AddressSPOperand();
        goto ExecuteMultiply;
    case DispatchMultiplyFP:
        AddressFPOperand();
        goto ExecuteMultiply;
    case DispatchMultiplyLP:
        AddressLPOperand();
        goto ExecuteMultiply;
    case DispatchMultiplyPop:
        AddressPopOperand();
        goto ExecuteMultiply;
    ExecuteMultiply:
        MARK(Multiply);
    ...
    /* ---  Maybe handle single-floats */
    case DispatchQuotientImmediate:
        AddressImmediateOperand();
        goto ExecuteQuotient;
    case DispatchQuotientSP:
        AddressSPOperand();
        goto ExecuteQuotient;
    case DispatchQuotientFP:
        AddressFPOperand();
        goto ExecuteQuotient;
    case DispatchQuotientLP:
        AddressLPOperand();
        goto ExecuteQuotient;
    ...
    case DispatchFloorImmediate:
        AddressImmediateOperand();
        goto ExecuteFloor;
    case DispatchFloorSP:
        AddressSPOperand();
        goto ExecuteFloor;
    case DispatchFloorFP:
        AddressFPOperand();
        goto ExecuteFloor;
    case DispatchFloorLP:
        AddressLPOperand();
        goto ExecuteFloor;
    case DispatchFloorPop:
        AddressPopOperand();
        goto ExecuteFloor;
    ExecuteFloor:
        MARK(Floor);
    ...
    case DispatchCeilingImmediate:
        AddressImmediateOperand();
        goto ExecuteCeiling;
    case DispatchCeilingSP:
        AddressSPOperand();
        goto ExecuteCeiling;
    case DispatchCeilingFP:
        AddressFPOperand();
        goto ExecuteCeiling;
    case DispatchCeilingLP:
        AddressLPOperand();
        goto ExecuteCeiling;
    case DispatchCeilingPop:
        AddressPopOperand();
        goto ExecuteCeiling;
    ExecuteCeiling:
        MARK(Ceiling);
    ...
    case DispatchTruncateImmediate:
        AddressImmediateOperand();
        goto ExecuteTruncate;
    case DispatchTruncateSP:
        AddressSPOperand();
        goto ExecuteTruncate;
    case DispatchTruncateFP:
        AddressFPOperand();
        goto ExecuteTruncate;
    case DispatchTruncateLP:
        AddressLPOperand();
        goto ExecuteTruncate;
    case DispatchTruncatePop:
        AddressPopOperand();
        goto ExecuteTruncate;
    ExecuteTruncate:
        MARK(Truncate);
    ...
    case DispatchRoundImmediate:
        AddressImmediateOperand();
        goto ExecuteRound;
    case DispatchRoundSP:
        AddressSPOperand();
        goto ExecuteRound;
    case DispatchRoundFP:
        AddressFPOperand();
        goto ExecuteRound;
    case DispatchRoundLP:
        AddressLPOperand();
        goto ExecuteRound;
    case DispatchRoundPop:
        AddressPopOperand();
        goto ExecuteRound;
    ExecuteRound:
        MARK(Round);
    ...
    case DispatchRationalQuotientImmediate:
        AddressImmediateOperand();
        goto ExecuteRationalQuotient;
    case DispatchRationalQuotientSP:
        AddressSPOperand();
        goto ExecuteRationalQuotient;
    case DispatchRationalQuotientFP:
        AddressFPOperand();
        goto ExecuteRationalQuotient;
    case DispatchRationalQuotientLP:
        AddressLPOperand();
        goto ExecuteRationalQuotient;
    case DispatchRationalQuotientPop:
        AddressPopOperand();
        goto ExecuteRationalQuotient;
    ...
    case DispatchLogandImmediate:
        AddressImmediateOperand();
        goto ExecuteLogand;
    case DispatchLogandSP:
        AddressSPOperand();
        goto ExecuteLogand;
    case DispatchLogandFP:
        AddressFPOperand();
        goto ExecuteLogand;
    case DispatchLogandLP:
        AddressLPOperand();
        goto ExecuteLogand;
    case DispatchLogandPop:
        AddressPopOperand();
        goto ExecuteLogand;
    ExecuteLogand:
        MARK(Logand);
    ...
    case DispatchLogiorImmediate:
        AddressImmediateOperand();
        goto ExecuteLogior;
    case DispatchLogiorSP:
        AddressSPOperand();
        goto ExecuteLogior;
    case DispatchLogiorFP:
        AddressFPOperand();
        goto ExecuteLogior;
    case DispatchLogiorLP:
        AddressLPOperand();
        goto ExecuteLogior;
    case DispatchLogiorPop:
        AddressPopOperand();
        goto ExecuteLogior;
    ExecuteLogior:
        MARK(Logior);
    ...
    case DispatchLogxorImmediate:
        AddressImmediateOperand();
        goto ExecuteLogxor;
    case DispatchLogxorSP:
        AddressSPOperand();
        goto ExecuteLogxor;
    case DispatchLogxorFP:
        AddressFPOperand();
        goto ExecuteLogxor;
    case DispatchLogxorLP:
        AddressLPOperand();
        goto ExecuteLogxor;
    case DispatchLogxorPop:
        AddressPopOperand();
        goto ExecuteLogxor;
    ExecuteLogxor:
        MARK(Logxor);
    ...
    case Dispatch32BitPlusFP:
        AddressFPOperand();
        goto Execute32BitPlus;
    case Dispatch32BitPlusLP:
        AddressLPOperand();
        goto Execute32BitPlus;
    case Dispatch32BitPlusPop:
        AddressPopOperand();
        goto Execute32BitPlus;
    Execute32BitPlus:
        MARK(32BitPlus);
    ...
    case Dispatch32BitDifferenceFP:
        AddressFPOperand();
        goto Execute32BitDifference;
    case Dispatch32BitDifferenceLP:
        AddressLPOperand();
        goto Execute32BitDifference;
    case Dispatch32BitDifferencePop:
        AddressPopOperand();
        goto Execute32BitDifference;
    ...
    case DispatchMultiplyDoubleImmediate:
        AddressImmediateOperand();
        goto ExecuteMultiplyDouble;
    case DispatchMultiplyDoubleSP:
        AddressSPOperand();
        goto ExecuteMultiplyDouble;
    case DispatchMultiplyDoubleFP:
        AddressFPOperand();
        goto ExecuteMultiplyDouble;
    case DispatchMultiplyDoubleLP:
        AddressLPOperand();
        goto ExecuteMultiplyDouble;
    case DispatchMultiplyDoublePop:
        AddressPopOperand();
        goto ExecuteMultiplyDouble;
    ...
    case DispatchAddBignumStepImmediate:
        AddressImmediateOperand();
        goto ExecuteAddBignumStep;
    case DispatchAddBignumStepSP:
        AddressSPOperand();
        goto ExecuteAddBignumStep;
    case DispatchAddBignumStepFP:
        AddressFPOperand();
        goto ExecuteAddBignumStep;
    case DispatchAddBignumStepLP:
        AddressLPOperand();
        goto ExecuteAddBignumStep;
    case DispatchAddBignumStepPop:
        AddressPopOperand();
        goto ExecuteAddBignumStep;
    ...
    case DispatchSubBignumStepImmediate:
        AddressImmediateOperand();
        goto ExecuteSubBignumStep;
    case DispatchSubBignumStepSP:
        AddressSPOperand();
        goto ExecuteSubBignumStep;
    case DispatchSubBignumStepFP:
        AddressFPOperand();
        goto ExecuteSubBignumStep;
    case DispatchSubBignumStepLP:
        AddressLPOperand();
        goto ExecuteSubBignumStep;
    case DispatchSubBignumStepPop:
        AddressPopOperand();
        goto ExecuteSubBignumStep;
    ...
    case DispatchMultiplyBignumStepImmediate:
        AddressImmediateOperand();
        goto ExecuteMultiplyBignumStep;
    case DispatchMultiplyBignumStepSP:
        AddressSPOperand();
        goto ExecuteMultiplyBignumStep;
    case DispatchMultiplyBignumStepFP:
        AddressFPOperand();
        goto ExecuteMultiplyBignumStep;
    case DispatchMultiplyBignumStepLP:
        AddressLPOperand();
        goto ExecuteMultiplyBignumStep;
    case DispatchMultiplyBignumStepPop:
        AddressPopOperand();
        goto ExecuteMultiplyBignumStep;
    ...
    case DispatchDivideBignumStepImmediate:
        AddressImmediateOperand();
        goto ExecuteDivideBignumStep;
    case DispatchDivideBignumStepSP:
        AddressSPOperand();
        goto ExecuteDivideBignumStep;
    case DispatchDivideBignumStepFP:
        AddressFPOperand();
        goto ExecuteDivideBignumStep;
    case DispatchDivideBignumStepLP:
        AddressLPOperand();
        goto ExecuteDivideBignumStep;
    ...
    case DispatchLshcBignumStepImmediate:
        AddressImmediateOperand();
        goto ExecuteLshcBignumStep;
    case DispatchLshcBignumStepSP:
        AddressSPOperand();
        goto ExecuteLshcBignumStep;
    case DispatchLshcBignumStepFP:
        AddressFPOperand();
        goto ExecuteLshcBignumStep;
    case DispatchLshcBignumStepLP:
        AddressLPOperand();
        goto ExecuteLshcBignumStep;
    case DispatchLshcBignumStepPop:
        AddressPopOperand();
        goto ExecuteLshcBignumStep;
    ...
    case DispatchMovemPop:
        NextInstruction;
    case DispatchMovemSP:
        AddressSPOperand();
        MoveObject(op2);
        NextInstruction;
    case DispatchMovemFP:
        AddressFPOperand();
        MoveObject(op2);
        NextInstruction;
    case DispatchMovemLP:
        AddressLPOperand();
        MoveObject(op2);
        NextInstruction;
    ...
    case DispatchPushAddressSP:
        AddressSPOperand();
        goto ExecutePushAddress;
    case DispatchPushAddressFP:
        AddressFPOperand();
        goto ExecutePushAddress;
    case DispatchPushAddressLP:
        AddressLPOperand();
        goto ExecutePushAddress;
    ExecutePushAddress:
        MARK(PushAddress);
    ...
    case DispatchSetSpToAddressSP:
        sp = AddressSPOperand();
        NextInstruction;
    case DispatchSetSpToAddressFP:
        sp = AddressFPOperand();
        NextInstruction;
    case DispatchSetSpToAddressLP:
        sp = AddressLPOperand();
        NextInstruction;

    case DispatchSetSpToAddressSaveTosSP:
        AddressSPOperand();
        goto ExecuteSetSpToAddressSaveTos;
    case DispatchSetSpToAddressSaveTosFP:
        AddressFPOperand();
        goto ExecuteSetSpToAddressSaveTos;
    case DispatchSetSpToAddressSaveTosLP:
        AddressLPOperand();
        goto ExecuteSetSpToAddressSaveTos;
    ...
    case DispatchPushAddressSpRelativeSP:
        AddressSPOperand();
        goto ExecutePushAddressSpRelative;
    case DispatchPushAddressSpRelativeFP:
        AddressFPOperand();
        goto ExecutePushAddressSpRelative;
    case DispatchPushAddressSpRelativeLP:
        AddressLPOperand();
        goto ExecutePushAddressSpRelative;
    case DispatchPushAddressSpRelativePop:
        AddressPopOperand();
        goto ExecutePushAddressSpRelative;
    ...
    case DispatchStackBltSP:
        AddressSPOperand();
        goto ExecuteStackBlt;
    case DispatchStackBltFP:
        AddressFPOperand();
        goto ExecuteStackBlt;
    case DispatchStackBltLP:
        AddressLPOperand();
        goto ExecuteStackBlt;
    case DispatchStackBltPop:
        AddressPopOperand();
        goto ExecuteStackBlt;
    ExecuteStackBlt:
        MARK(StackBlt);
    ...
    case DispatchStackBltAddressSP:
        AddressSPOperand();
        goto ExecuteStackBltAddress;
    case DispatchStackBltAddressFP:
        AddressFPOperand();
        goto ExecuteStackBltAddress;
    case DispatchStackBltAddressLP:
        AddressLPOperand();
        goto ExecuteStackBltAddress;
    case DispatchStackBltAddressPop:
        AddressPopOperand();
        goto ExecuteStackBltAddress;
    ...
    case DispatchAref1Immediate:
        AddressImmediateOperand();
        goto ExecuteAref1;
    case DispatchAref1SP:
        AddressSPOperand();
        goto ExecuteAref1;
    case DispatchAref1FP:
        AddressFPOperand();
        goto ExecuteAref1;
    case DispatchAref1LP:
        AddressLPOperand();
        goto ExecuteAref1;
    case DispatchAref1Pop:
        AddressPopOperand();
        goto ExecuteAref1;
    ExecuteAref1:
        MARK(Aref1);
    ...
    case DispatchAset1Immediate:
        AddressImmediateOperand();
        goto ExecuteAset1;
    case DispatchAset1SP:
        AddressSPOperand();
        goto ExecuteAset1;
    case DispatchAset1FP:
        AddressFPOperand();
        goto ExecuteAset1;
    case DispatchAset1LP:
        AddressLPOperand();
        goto ExecuteAset1;
    case DispatchAset1Pop:
        AddressPopOperand();
        goto ExecuteAset1;
    ExecuteAset1:
        MARK(Aset1);
    ...
    case DispatchAloc1Immediate:
        AddressImmediateOperand();
        goto ExecuteAloc1;
    case DispatchAloc1SP:
        AddressSPOperand();
        goto ExecuteAloc1;
    case DispatchAloc1FP:
        AddressFPOperand();
        goto ExecuteAloc1;
    case DispatchAloc1LP:
        AddressLPOperand();
        goto ExecuteAloc1;
    case DispatchAloc1Pop:
        AddressPopOperand();
        goto ExecuteAloc1;
    ExecuteAloc1:
        MARK(Aloc1);
    ...
    case DispatchSetup1dArrayImmediate:
        UnimplementedInstruction;
    case DispatchSetup1dArraySP:
        AddressSPOperand();
        goto ExecuteSetup1dArray;
    case DispatchSetup1dArrayFP:
        AddressFPOperand();
        goto ExecuteSetup1dArray;
    case DispatchSetup1dArrayLP:
        AddressLPOperand();
        goto ExecuteSetup1dArray;
    case DispatchSetup1dArrayPop:
        AddressPopOperand();
        goto ExecuteSetup1dArray;
     ...
     * instruction opcode.
     */
    case DispatchSetupForce1dArraySP:
        AddressSPOperand();
        goto ExecuteSetupForce1dArray;
    case DispatchSetupForce1dArrayFP:
        AddressFPOperand();
        goto ExecuteSetupForce1dArray;
    case DispatchSetupForce1dArrayLP:
        AddressLPOperand();
        goto ExecuteSetupForce1dArray;
    case DispatchSetupForce1dArrayPop:
        AddressPopOperand();
        goto ExecuteSetupForce1dArray;
    ...
    case DispatchFastAref1SP:
        AddressSPOperand();
        goto ExecuteFastAref1;
    case DispatchFastAref1FP:
        AddressFPOperand();
        goto ExecuteFastAref1;
    case DispatchFastAref1LP:
        AddressLPOperand();
        goto ExecuteFastAref1;
    ExecuteFastAref1:
        MARK(FastAref1);
    ...
    case DispatchFastAset1SP:
        AddressSPOperand();
        goto ExecuteFastAset1;
    case DispatchFastAset1FP:
        AddressFPOperand();
        goto ExecuteFastAset1;
    case DispatchFastAset1LP:
        AddressLPOperand();
        goto ExecuteFastAset1;
    ExecuteFastAset1:
        MARK(FastAset1);
    ...
    case DispatchArrayLeaderImmediate:
        AddressImmediateOperand();
        goto ExecuteArrayLeader;
    case DispatchArrayLeaderSP:
        AddressSPOperand();
        goto ExecuteArrayLeader;
    case DispatchArrayLeaderFP:
        AddressFPOperand();
        goto ExecuteArrayLeader;
    case DispatchArrayLeaderLP:
        AddressLPOperand();
        goto ExecuteArrayLeader;
    case DispatchArrayLeaderPop:
        AddressPopOperand();
        goto ExecuteArrayLeader;
    ExecuteArrayLeader:
        MARK(ArrayLeader);
    ...
    case DispatchStoreArrayLeaderImmediate:
        AddressImmediateOperand();
        goto ExecuteStoreArrayLeader;
    case DispatchStoreArrayLeaderSP:
        AddressSPOperand();
        goto ExecuteStoreArrayLeader;
    case DispatchStoreArrayLeaderFP:
        AddressFPOperand();
        goto ExecuteStoreArrayLeader;
    case DispatchStoreArrayLeaderLP:
        AddressLPOperand();
        goto ExecuteStoreArrayLeader;
    case DispatchStoreArrayLeaderPop:
        AddressPopOperand();
        goto ExecuteStoreArrayLeader;
    ...
    case DispatchAlocLeaderImmediate:
        AddressImmediateOperand();
        goto ExecuteAlocLeader;
    case DispatchAlocLeaderSP:
        AddressSPOperand();
        goto ExecuteAlocLeader;
    case DispatchAlocLeaderFP:
        AddressFPOperand();
        goto ExecuteAlocLeader;
    case DispatchAlocLeaderLP:
        AddressLPOperand();
        goto ExecuteAlocLeader;
    case DispatchAlocLeaderPop:
        AddressPopOperand();
        goto ExecuteAlocLeader;
    ExecuteAlocLeader:
        MARK(AlocLeader);
    ...
    case DispatchLoopDecrementTos:
        if (TypeFixnumP(sp->TAG) && (i = sp->DATA.s - 1) < sp->DATA.s) {
    ...
    case DispatchLoopIncrementTosLessThan:
        ...
        if
            BinaryTypeNumericP(op2->TAG, sp->TAG)
                /* Exceptions see followed PC */
                goto FollowPCInstructionException;
        else
            IllegalOperand;

    case DispatchBlock1Read:
        AddressBAR(1);
        goto ExecuteBlockRead;
    case DispatchBlock2Read:
        AddressBAR(2);
        goto ExecuteBlockRead;
    case DispatchBlock3Read:
        AddressBAR(3);
        goto ExecuteBlockRead;
    ExecuteBlockRead:
        MARK(BlockRead);
    ...
    case DispatchBlock1ReadShift:
        AddressBAR(1);
        goto ExecuteBlockReadShift;
    case DispatchBlock2ReadShift:
        AddressBAR(2);
        goto ExecuteBlockReadShift;
    case DispatchBlock3ReadShift:
        AddressBAR(3);
        goto ExecuteBlockReadShift;
    ...
    case DispatchBlock1ReadTest:
        AddressBAR(1);
        goto ExecuteBlockReadTest;
    case DispatchBlock2ReadTest:
        AddressBAR(2);
        goto ExecuteBlockReadTest;
    case DispatchBlock3ReadTest:
        AddressBAR(3);
        goto ExecuteBlockReadTest;
    ...
    case DispatchBlock1WriteImmediate:
        AddressImmediateOperand();
        AddressBAR(1);
        goto ExecuteBlockWrite;
    case DispatchBlock2WriteImmediate:
        AddressImmediateOperand();
        AddressBAR(2);
        goto ExecuteBlockWrite;
    case DispatchBlock3WriteImmediate:
        AddressImmediateOperand();
        AddressBAR(3);
        goto ExecuteBlockWrite;
    case DispatchBlock1WriteSP:
        AddressSPOperand();
        AddressBAR(1);
        goto ExecuteBlockWrite;
    case DispatchBlock1WriteFP:
        AddressFPOperand();
        AddressBAR(1);
        goto ExecuteBlockWrite;
    case DispatchBlock1WriteLP:
        AddressLPOperand();
        AddressBAR(1);
        goto ExecuteBlockWrite;
    case DispatchBlock1WritePop:
        AddressPopOperand();
        AddressBAR(1);
        goto ExecuteBlockWrite;
    case DispatchBlock2WriteSP:
        AddressSPOperand();
        AddressBAR(2);
        goto ExecuteBlockWrite;
    case DispatchBlock2WriteFP:
        AddressFPOperand();
        AddressBAR(2);
        goto ExecuteBlockWrite;
    case DispatchBlock2WriteLP:
        AddressLPOperand();
        AddressBAR(2);
        goto ExecuteBlockWrite;
    case DispatchBlock2WritePop:
        AddressPopOperand();
        AddressBAR(2);
        goto ExecuteBlockWrite;
    case DispatchBlock3WriteSP:
        AddressSPOperand();
        AddressBAR(3);
        goto ExecuteBlockWrite;
    case DispatchBlock3WriteFP:
        AddressFPOperand();
        AddressBAR(3);
        goto ExecuteBlockWrite;
    case DispatchBlock3WriteLP:
        AddressLPOperand();
        AddressBAR(3);
        goto ExecuteBlockWrite;
    case DispatchBlock3WritePop:
        AddressPopOperand();
        AddressBAR(3);
        goto ExecuteBlockWrite;
    ExecuteBlockWrite:
    ...
    case DispatchStartCallSP:
        AddressSPOperand();
        goto ExecuteStartCall;
    case DispatchStartCallFP:
        AddressFPOperand();
        goto ExecuteStartCall;
    case DispatchStartCallLP:
        AddressLPOperand();
        goto ExecuteStartCall;
    case DispatchStartCallPop:
        AddressPopOperand();
        goto ExecuteStartCall;
    ExecuteStartCall:
        MARK(StartCall);
    ...
    retryReturnSingle:
        ...
        /* --- debug
        if ((fp[-ReadControlCallerFrameSize(ps->control)].TAG&-2) !=
        ((TypeEvenPC&-2)|(3<<6))) InstructionException;
         */
    ...
    case DispatchReturnMultipleImmediate:
        AddressImmediateOperand();
        goto ExecuteReturnMultiple;
    case DispatchReturnMultiplePop:
        AddressPopOperand();
        goto ExecuteReturnMultiple;
    ExecuteReturnMultiple:
        ...
        retryReturnMultiple:
            ...
            */
            ...
            case ValueDispositionValue:
                if (count > 0)
                    PushObject(valueblock) else PushNIL();
                break;
            case ValueDispositionMultiple:
                for (i = count; i--;) {
    ...
    case DispatchReturnKludgeImmediate:
        AddressImmediateOperand();
        goto ExecuteReturnKludge;
    case DispatchReturnKludgePop:
        AddressPopOperand();
        goto ExecuteReturnKludge;
    ExecuteReturnKludge:
        MARK(ReturnKludge);
    ...
    case DispatchBindLocativeToValueImmediate:
        AddressImmediateOperand();
        goto ExecuteBindLocativeToValue;
    case DispatchBindLocativeToValueSP:
        AddressSPOperand();
        goto ExecuteBindLocativeToValue;
    case DispatchBindLocativeToValueFP:
        AddressFPOperand();
        goto ExecuteBindLocativeToValue;
    case DispatchBindLocativeToValueLP:
        AddressLPOperand();
        goto ExecuteBindLocativeToValue;
    case DispatchBindLocativeToValuePop:
        AddressPopOperand();
        goto ExecuteBindLocativeToValue;
    ...
    case DispatchBindLocativeSP:
        AddressSPOperand();
        goto ExecuteBindLocative;
    case DispatchBindLocativeFP:
        AddressFPOperand();
        goto ExecuteBindLocative;
    case DispatchBindLocativeLP:
        AddressLPOperand();
        goto ExecuteBindLocative;
    case DispatchBindLocativePop:
        AddressPopOperand();
        goto ExecuteBindLocative;
    ExecuteBindLocative:
        MARK(BindLocative);
    ...
    case DispatchUnbindNImmediate:
        AddressImmediateOperand();
        goto ExecuteUnbindN;
    case DispatchUnbindNPop:
        AddressPopOperand();
        goto ExecuteUnbindN;
    ExecuteUnbindN:
        MARK(UnbindN);
    ...
    case DispatchRestoreBindingStackSP:
        AddressSPOperand();
        goto ExecuteRestoreBindingStack;
    case DispatchRestoreBindingStackFP:
        AddressFPOperand();
        goto ExecuteRestoreBindingStack;
    case DispatchRestoreBindingStackLP:
        AddressLPOperand();
        goto ExecuteRestoreBindingStack;
    ...
    case DispatchPushLexicalVarImmediate:
        UnimplementedInstruction;
    case DispatchPushLexicalVarSP:
        AddressSPOperand();
        goto ExecutePushLexicalVar;
    case DispatchPushLexicalVarFP:
        AddressFPOperand();
        goto ExecutePushLexicalVar;
    case DispatchPushLexicalVarLP:
        AddressLPOperand();
        goto ExecutePushLexicalVar;
    case DispatchPushLexicalVarPop:
        AddressPopOperand();
        goto ExecutePushLexicalVar;
    ...
    case DispatchPopLexicalVarImmediate:
        UnimplementedInstruction;
    case DispatchPopLexicalVarSP:
        AddressSPOperand();
        goto ExecutePopLexicalVar;
    case DispatchPopLexicalVarFP:
        AddressFPOperand();
        goto ExecutePopLexicalVar;
    case DispatchPopLexicalVarLP:
        AddressLPOperand();
        goto ExecutePopLexicalVar;
    case DispatchPopLexicalVarPop:
        AddressPopOperand();
        goto ExecutePopLexicalVar;
    ...
    case DispatchMovemLexicalVarImmediate:
        UnimplementedInstruction;
    case DispatchMovemLexicalVarSP:
        AddressSPOperand();
        goto ExecuteMovemLexicalVar;
    case DispatchMovemLexicalVarFP:
        AddressFPOperand();
        goto ExecuteMovemLexicalVar;
    case DispatchMovemLexicalVarLP:
        AddressLPOperand();
        goto ExecuteMovemLexicalVar;
    case DispatchMovemLexicalVarPop:
        AddressPopOperand();
        goto ExecuteMovemLexicalVar;
    ...
    case DispatchInstanceRefImmediate:
        AddressImmediateOperand();
        goto ExecuteInstanceRef;
    case DispatchInstanceRefSP:
        AddressSPOperand();
        goto ExecuteInstanceRef;
    case DispatchInstanceRefFP:
        AddressFPOperand();
        goto ExecuteInstanceRef;
    case DispatchInstanceRefLP:
        AddressLPOperand();
        goto ExecuteInstanceRef;
    case DispatchInstanceRefPop:
        AddressPopOperand();
        goto ExecuteInstanceRef;
    ExecuteInstanceRef:
        MARK(InstanceRef);
    ...
    case DispatchInstanceSetImmediate:
        AddressImmediateOperand();
        goto ExecuteInstanceSet;
    case DispatchInstanceSetSP:
        AddressSPOperand();
        goto ExecuteInstanceSet;
    case DispatchInstanceSetFP:
        AddressFPOperand();
        goto ExecuteInstanceSet;
    case DispatchInstanceSetLP:
        AddressLPOperand();
        goto ExecuteInstanceSet;
    case DispatchInstanceSetPop:
        AddressPopOperand();
        goto ExecuteInstanceSet;
    ExecuteInstanceSet:
        MARK(InstanceSet);
    ...
    case DispatchInstanceLocImmediate:
        AddressImmediateOperand();
        goto ExecuteInstanceSet;
    case DispatchInstanceLocSP:
        AddressSPOperand();
        goto ExecuteInstanceLoc;
    case DispatchInstanceLocFP:
        AddressFPOperand();
        goto ExecuteInstanceLoc;
    case DispatchInstanceLocLP:
        AddressLPOperand();
        goto ExecuteInstanceLoc;
    case DispatchInstanceLocPop:
        AddressPopOperand();
        goto ExecuteInstanceLoc;
    ExecuteInstanceLoc:
        MARK(InstanceLoc);
    ...
    case DispatchEphemeralpImmediate:
        UnimplementedInstruction;
    case DispatchEphemeralpSP:
        AddressSPOperand();
        goto ExecuteEphemeralp;
    case DispatchEphemeralpFP:
        AddressFPOperand();
        goto ExecuteEphemeralp;
    case DispatchEphemeralpLP:
        AddressLPOperand();
        goto ExecuteEphemeralp;
    case DispatchEphemeralpPop:
        AddressPopOperand();
        goto ExecuteEphemeralp;
    ExecuteEphemeralp:
        MARK(Ephemeralp);
    ...
    case DispatchUnsignedLesspImmediate:
        ...
        NextInstruction;
    case DispatchUnsignedLesspSP:
        AddressSPOperand();
        goto ExecuteUnsignedLessp;
    case DispatchUnsignedLesspFP:
        AddressFPOperand();
        goto ExecuteUnsignedLessp;
    case DispatchUnsignedLesspLP:
        AddressLPOperand();
        goto ExecuteUnsignedLessp;
    case DispatchUnsignedLesspPop:
        AddressPopOperand();
        goto ExecuteUnsignedLessp;
    ...
    case DispatchUnsignedLesspNoPopImmediate:
        ...
        NextInstruction;
    case DispatchUnsignedLesspNoPopSP:
        AddressSPOperand();
        goto ExecuteUnsignedLesspNoPop;
    case DispatchUnsignedLesspNoPopFP:
        AddressFPOperand();
        goto ExecuteUnsignedLesspNoPop;
    case DispatchUnsignedLesspNoPopLP:
        AddressLPOperand();
        goto ExecuteUnsignedLesspNoPop;
    case DispatchUnsignedLesspNoPopPop:
        AddressPopOperand();
        goto ExecuteUnsignedLesspNoPop;
    ...
    case DispatchAllocateListBlockImmediate:
        AddressImmediateOperand();
        goto ExecuteAllocateListBlock;
    case DispatchAllocateListBlockSP:
        AddressSPOperand();
        goto ExecuteAllocateListBlock;
    case DispatchAllocateListBlockFP:
        AddressFPOperand();
        goto ExecuteAllocateListBlock;
    case DispatchAllocateListBlockLP:
        AddressLPOperand();
        goto ExecuteAllocateListBlock;
    case DispatchAllocateListBlockPop:
        AddressPopOperand();
        goto ExecuteAllocateListBlock;
    ...
    case DispatchAllocateStructureBlockImmediate:
        AddressImmediateOperand();
        goto ExecuteAllocateListBlock;
    case DispatchAllocateStructureBlockSP:
        AddressSPOperand();
        goto ExecuteAllocateStructureBlock;
    case DispatchAllocateStructureBlockFP:
        AddressFPOperand();
        goto ExecuteAllocateStructureBlock;
    case DispatchAllocateStructureBlockLP:
        AddressLPOperand();
        goto ExecuteAllocateStructureBlock;
    case DispatchAllocateStructureBlockPop:
        AddressPopOperand();
        goto ExecuteAllocateStructureBlock;
    ...
    case DispatchPointerPlusImmediate:
        sp->DATA.u += cp->operand;
        NextInstruction;
    case DispatchPointerPlusSP:
        AddressSPOperand();
        goto ExecutePointerPlus;
    case DispatchPointerPlusFP:
        AddressFPOperand();
        goto ExecutePointerPlus;
    case DispatchPointerPlusLP:
        AddressLPOperand();
        goto ExecutePointerPlus;
    case DispatchPointerPlusPop:
        AddressPopOperand();
        goto ExecutePointerPlus;
    ExecutePointerPlus:
        MARK(PointerPlus);
    ...
    case DispatchPointerDifferenceImmediate:
        ...
        NextInstruction;
    case DispatchPointerDifferenceSP:
        AddressSPOperand();
        goto ExecutePointerDifference;
    case DispatchPointerDifferenceFP:
        AddressFPOperand();
        goto ExecutePointerDifference;
    case DispatchPointerDifferenceLP:
        AddressLPOperand();
        goto ExecutePointerDifference;
    case DispatchPointerDifferencePop:
        AddressPopOperand();
        goto ExecutePointerDifference;
    ...
    case DispatchPointerIncrementSP:
        AddressSPOperand();
        goto ExecutePointerIncrement;
    case DispatchPointerIncrementFP:
        AddressFPOperand();
        goto ExecutePointerIncrement;
    case DispatchPointerIncrementLP:
        AddressLPOperand();
        goto ExecutePointerIncrement;
    ...
    case DispatchSetTagImmediate:
        sp->TAG = cp->operand;
        NextInstruction;
    case DispatchSetTagSP:
        AddressSPOperand();
        goto ExecuteSetTag;
    case DispatchSetTagFP:
        AddressFPOperand();
        goto ExecuteSetTag;
    case DispatchSetTagLP:
        AddressLPOperand();
        goto ExecuteSetTag;
    case DispatchSetTagPop:
        AddressPopOperand();
        goto ExecuteSetTag;
    ExecuteSetTag:
        MARK(SetTag);
    ...
    case DispatchStoreConditionalImmediate:
        AddressImmediateOperand();
        goto ExecuteStoreConditional;
    case DispatchStoreConditionalSP:
        AddressSPOperand();
        goto ExecuteStoreConditional;
    case DispatchStoreConditionalFP:
        AddressFPOperand();
        goto ExecuteStoreConditional;
    case DispatchStoreConditionalLP:
        AddressLPOperand();
        goto ExecuteStoreConditional;
    case DispatchStoreConditionalPop:
        AddressPopOperand();
        goto ExecuteStoreConditional;
    ...
    case DispatchMemoryWriteImmediate:
        AddressImmediateOperand();
        goto ExecuteMemoryWrite;
    case DispatchMemoryWriteSP:
        AddressSPOperand();
        goto ExecuteMemoryWrite;
    case DispatchMemoryWriteFP:
        AddressFPOperand();
        goto ExecuteMemoryWrite;
    case DispatchMemoryWriteLP:
        AddressLPOperand();
        goto ExecuteMemoryWrite;
    case DispatchMemoryWritePop:
        AddressPopOperand();
        goto ExecuteMemoryWrite;
    ExecuteMemoryWrite:
        MARK(MemoryWrite);
    ...
    case DispatchPStoreContentsImmediate:
        AddressImmediateOperand();
        goto ExecutePStoreContents;
    case DispatchPStoreContentsSP:
        AddressSPOperand();
        goto ExecutePStoreContents;
    case DispatchPStoreContentsFP:
        AddressFPOperand();
        goto ExecutePStoreContents;
    case DispatchPStoreContentsLP:
        AddressLPOperand();
        goto ExecutePStoreContents;
    case DispatchPStoreContentsPop:
        AddressPopOperand();
        goto ExecutePStoreContents;
    ...
    case DispatchSetCdrCode1SP:
        AddressSPOperand();
        goto ExecuteSetCdrCode1;
    case DispatchSetCdrCode1FP:
        AddressFPOperand();
        goto ExecuteSetCdrCode1;
    case DispatchSetCdrCode1LP:
        AddressLPOperand();
        goto ExecuteSetCdrCode1;
    ExecuteSetCdrCode1:
        MARK(SetCdrCode1);
    ...
    case DispatchSetCdrCode2SP:
        AddressSPOperand();
        goto ExecuteSetCdrCode2;
    case DispatchSetCdrCode2FP:
        AddressFPOperand();
        goto ExecuteSetCdrCode2;
    case DispatchSetCdrCode2LP:
        AddressLPOperand();
        goto ExecuteSetCdrCode2;
    ExecuteSetCdrCode2:
        MARK(SetCdrCode2);
    ...
    case DispatchMergeCdrNoPopSP:
        AddressSPOperand();
        goto ExecuteMergeCdrNoPop;
    case DispatchMergeCdrNoPopFP:
        AddressFPOperand();
        goto ExecuteMergeCdrNoPop;
    case DispatchMergeCdrNoPopLP:
        AddressLPOperand();
        goto ExecuteMergeCdrNoPop;
    ...
    case DispatchPushFixnum:
        PushConstant(TypeFixnum, cp->operand);
        NextInstruction;
    case DispatchPushSmallRatio:
        PushConstant(TypeSmallRatio, cp->operand);
        NextInstruction;
    case DispatchPushSingleFloat:
        PushConstant(TypeSingleFloat, cp->operand);
        NextInstruction;
    case DispatchPushDoubleFloat:
        PushConstant(TypeDoubleFloat, cp->operand);
        NextInstruction;
    case DispatchPushBignum:
        PushConstant(TypeBignum, cp->operand);
        NextInstruction;
    case DispatchPushBigRatio:
        PushConstant(TypeBigRatio, cp->operand);
        NextInstruction;
    case DispatchPushComplex:
        PushConstant(TypeComplex, cp->operand);
        NextInstruction;
    case DispatchPushSpareNumber:
        PushConstant(TypeSpareNumber, cp->operand);
        NextInstruction;
    case DispatchPushInstance:
        PushConstant(TypeInstance, cp->operand);
        NextInstruction;
    case DispatchPushListInstance:
        PushConstant(TypeListInstance, cp->operand);
        NextInstruction;
    case DispatchPushArrayInstance:
        PushConstant(TypeArrayInstance, cp->operand);
        NextInstruction;
    case DispatchPushStringInstance:
        PushConstant(TypeStringInstance, cp->operand);
        NextInstruction;
    case DispatchPushNil:
        PushConstant(TypeNIL, cp->operand);
        NextInstruction;
    case DispatchPushList:
        PushConstant(TypeList, cp->operand);
        NextInstruction;
    case DispatchPushArray:
        PushConstant(TypeArray, cp->operand);
        NextInstruction;
    case DispatchPushString:
        PushConstant(TypeString, cp->operand);
        NextInstruction;
    case DispatchPushSymbol:
        PushConstant(TypeSymbol, cp->operand);
        NextInstruction;
    case DispatchPushLocative:
        PushConstant(TypeLocative, cp->operand);
        NextInstruction;
    case DispatchPushLexicalClosure:
        PushConstant(TypeLexicalClosure, cp->operand);
        NextInstruction;
    case DispatchPushDynamicClosure:
        PushConstant(TypeDynamicClosure, cp->operand);
        NextInstruction;
    case DispatchPushCompiledFunction:
        PushConstant(TypeCompiledFunction, cp->operand);
        NextInstruction;
    case DispatchPushGenericFunction:
        PushConstant(TypeGenericFunction, cp->operand);
        NextInstruction;
    case DispatchPushSparePointer1:
        PushConstant(TypeSparePointer1, cp->operand);
        NextInstruction;
    case DispatchPushSparePointer2:
        PushConstant(TypeSparePointer2, cp->operand);
        NextInstruction;
    case DispatchPushPhysicalAddress:
        PushConstant(TypePhysicalAddress, cp->operand);
        NextInstruction;
    case DispatchPushSpareImmediate1:
        PushConstant(TypeSpareImmediate1, cp->operand);
        NextInstruction;
    case DispatchPushBoundLocation:
        PushConstant(TypeBoundLocation, cp->operand);
        NextInstruction;
    case DispatchPushCharacter:
        PushConstant(TypeCharacter, cp->operand);
        NextInstruction;
    case DispatchPushLogicVariable:
        PushConstant(TypeLogicVariable, cp->operand);
        NextInstruction;
    case DispatchPushGcForward:
        PushConstant(TypeGCForward, cp->operand);
        NextInstruction;
    case DispatchPushEvenPc:
        PushConstant(TypeEvenPC, cp->operand);
        NextInstruction;
    case DispatchPushOddPc:
        PushConstant(TypeOddPC, cp->operand);
        NextInstruction;

    case DispatchDereferenceSP:
        AddressSPOperand();
        goto ExecuteDereference;
    case DispatchDereferenceFP:
        AddressFPOperand();
        goto ExecuteDereference;
    case DispatchDereferenceLP:
        AddressLPOperand();
        goto ExecuteDereference;
    case DispatchDereferencePop:
        AddressPopOperand();
        goto ExecuteDereference;
    ExecuteDereference:
        MARK(Dereference);
    ...
    case DispatchUnifySP:
        AddressSPOperand();
        goto ExecuteUnify;
    case DispatchUnifyFP:
        AddressFPOperand();
        goto ExecuteUnify;
    case DispatchUnifyLP:
        AddressLPOperand();
        goto ExecuteUnify;
    case DispatchUnifyPop:
        AddressPopOperand();
        goto ExecuteUnify;
    ExecuteUnify:
        MARK(Unify);
    ...
    case DispatchPushLocalLogicVariablesImmediate:
        UnimplementedInstruction;
    case DispatchPushLocalLogicVariablesSP:
        AddressSPOperand();
        goto ExecutePushLocalLogicVariables;
    case DispatchPushLocalLogicVariablesFP:
        AddressFPOperand();
        goto ExecutePushLocalLogicVariables;
    case DispatchPushLocalLogicVariablesLP:
        AddressLPOperand();
        goto ExecutePushLocalLogicVariables;
    case DispatchPushLocalLogicVariablesPop:
        AddressPopOperand();
        goto ExecutePushLocalLogicVariables;
    ...
    case DispatchLogicTailTestImmediate:
        UnimplementedInstruction;
    case DispatchLogicTailTestSP:
        AddressSPOperand();
        goto ExecuteLogicTailTest;
    case DispatchLogicTailTestFP:
        AddressFPOperand();
        goto ExecuteLogicTailTest;
    case DispatchLogicTailTestLP:
        AddressLPOperand();
        goto ExecuteLogicTailTest;
    case DispatchLogicTailTestPop:
        AddressPopOperand();
        goto ExecuteLogicTailTest;
...
BinaryTypeFixnumExceptions:
    if
        BinaryTypeNumericP(op2->TAG, sp->TAG) InstructionException;
    IllegalOperand;
...
IllegalOperandTag:
    ...
    }
    {
        ...
        /* --- not always op2, but maybe the non-op2 cases vma is not valid
         * anyways? */
