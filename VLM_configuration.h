...
/* We'll place the communications area immediately after the BootComm and
   BootData areas in "VMA=PMA" space.  Those two area occupy 128 (#x80) words
   starting at #xFFFE0000. Thus, the communications area will begin at
   location #xFFFE0080 and can be no more than #x1FF80 (130944) words. */
...
/* Channel Queue sizes -- Eventually, these could be parameters in the
 * configuration file */
