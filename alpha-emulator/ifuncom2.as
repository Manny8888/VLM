...
here;
inline
(define-instruction |DoAdd|; :operand-from-stack (;:own-immediate; needs-tos; t;)
...
(define-instruction |DoFastAref1|; :operand-from-stack (;:needs-tos; t;)
    (stack-read2; iSP; arg3; tos-valid; signed; t;)
...
(;
with-multiple - memory - reads(t9 t10;
t11;
t12;
)
must;
...
IFUNPRED.AS
;Handles;
DoEqualNumberNoPop as well
(define-instruction |DoEqualNumber|; :operand-from-stack (;:own-immediate; needs-tos; t;)
...
deal as | DoAdd |;
...
(define-instruction |DoSub|; :operand-from-stack (;:own-immediate; needs-tos; t;)
...
IFUNPRED.AS
;Handles;
DoLesspNoPop as well
(define-instruction |DoLessp|; :operand-from-stack (;:own-immediate; needs-tos; t;)
    (simple-binary-arithmetic-predicate;
