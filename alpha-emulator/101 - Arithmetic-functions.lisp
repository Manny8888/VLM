...
(define-instruction |DoQuotient| :operand-from-stack
  (:needs-tos t :provide-immediate t :signed-immediate t)
...
(define-instruction |DoRationalQuotient| :operand-from-stack
  (:needs-tos t :provide-immediate t :signed-immediate t)
  (BSR r0 |BinaryArithmeticDivisionPrelude|)
  (binary-arithmetic-one-value-division-operation :rational))

(define-instruction |DoFloor| :operand-from-stack
  (:needs-tos t :provide-immediate t :signed-immediate t)
  (BSR r0 |BinaryArithmeticDivisionPrelude|)
  (binary-arithmetic-two-value-division-operation :down))

(define-instruction |DoCeiling| :operand-from-stack
  (:needs-tos t :provide-immediate t :signed-immediate t)
  (BSR r0 |BinaryArithmeticDivisionPrelude|)
  (binary-arithmetic-two-value-division-operation :up))

(define-instruction |DoTruncate| :operand-from-stack
  (:needs-tos t :provide-immediate t :signed-immediate t)
  (BSR r0 |BinaryArithmeticDivisionPrelude|)
  (binary-arithmetic-two-value-division-operation :truncate))

(define-instruction |DoRound| :operand-from-stack
  (:needs-tos t :provide-immediate t :signed-immediate t)
  (BSR r0 |BinaryArithmeticDivisionPrelude|)
