...
;register.We;
don;
't care if our store fails, that simply means
;another;
thread;
ran;
and;
...
we
;won;
't have clobbered it and will deal with it next cycle.  If the
;clear;
succeeds, we;
also;
clear;
stop_interpreter, since;
we;
know
;that;
there;
...
---This;
wouldn;
't work if we needed it, since high-pri can
;clobber;
low - pri;
Luckily, we;
don;
