...
(align4k)					;starting; at; an; arbitrary; 4;k; boundary.

;Nota;
CACHELINE_INSTRUCTION / CACHELINE_OPERAND;
have;
a;
much;
more
...
think.For;
Full - word
;instructions, CACHELINE_INSTRUCTION;
holds;
the;
instruction;
with the
...
odd;
PC;
's cache pointer immediately follows
...
#
-old - cache - hash(SRL;
iPC | CacheLineRShift | arg2;
)

#
-old - cache - hash(SLL;
arg2 | CacheLineLShift | arg2;
)
