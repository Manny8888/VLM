...
;Handles;
DoGreaterpNoPop as well
(define-instruction |DoGreaterp|; :operand-from-stack (;:own-immediate; needs-tos; t;)
...
Handles;
DoLogtestNoPop as well
(define-instruction |DoLogtest|; :operand-from-stack (;:own-immediate; needs-tos; t;)
    (simple-binary-arithmetic-predicate;
