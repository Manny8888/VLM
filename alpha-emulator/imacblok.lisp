...
(defmacro i%block-n-read (bar op vma tag data cycle temp3 temp4 temp5 temp6 temp9 temp10 temp11 temp12)
  ...
  (let ((fntest (gensym "i_block_n_read"))
	      (nofntest (gensym "i_block_n_read"))
	      (ielab (gensym "i_block_n_read")))
    (push
     `((label ,fntest)
...
(defmacro i%block-n-read-shift (bar op temp temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12)
  ...
  (let ((nofntest (gensym "i_block_n_read_shift"))
	      (noincp (gensym "i_block_n_read_shift"))
	      (noclrcdr (gensym "i_block_n_read_shift"))
	      (ielab (gensym "i_block_n_read_shift")))
...
(defmacro i%block-n-read-alu (bar addr temp temp2 temp3 temp4 temp5 temp6 temp7 temp8 temp9 temp10 temp11 temp12)
  ...
  (let ((ielab2 (gensym "i_block_n_read_alu"))
	(ielab1 (gensym "i_block_n_read_alu"))
	(op1tag temp2)
	(op1data temp3)
	(op2tag temp4)
	(op2data temp5)
...
(defmacro i%block-n-read-test (bar op vma temp temp2 temp3 temp4 temp5 temp6
  ...
  (let ((nofntest (gensym "i_block_n_read_test"))
	      (noincp (gensym "i_block_n_read_test"))
	      (noclrcdr (gensym "i_block_n_read_test"))
	      (ielab1 (gensym "i_block_n_read_test"))
	      (ielab2 (gensym "i_block_n_read_test"))
	      (taken (gensym "i_block_n_read_test"))
	      (op1tag temp2 )
	      (op1data temp3)
	      (op2tag temp4)
	      (op2data temp5)
