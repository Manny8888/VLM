...
be;
careful
(define-instruction |DoRot|; :operand-from-stack (;:own-immediate; needs-tos; t;)
...
(define-instruction |Do32BitPlus|; :operand-from-stack (;:own-immediate; needs-tos; t;)
    (;with-simple-binary-fixnum-operation (t1 t2; t3; t4; t5; t7; t8 |Do32BitPlus|;)
      (ADDQ; t1; t2; t3; "Perform the 32 bit Add.";)))

(define-instruction |Do32BitDifference|; :operand-from-stack (;:own-immediate; needs-tos; t;)
