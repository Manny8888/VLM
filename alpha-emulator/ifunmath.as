...
(CheckFloatingOverflow;
arg6;
unaryminusexc;
t2;
)
(SUBS; f31; f1; f0;))
(fp - stack - push - ir | TypeSingleFloat | f0;
t7;
)
(SetNextPC; t6;)
...
Same;
deal | DoAdd | and | DoSub |;
...
(define-instruction |DoMultiply|; :operand-from-stack (;:own-immediate; needs-tos; t;)
...
slow;
...
(define-instruction |DoQuotient|; :operand-from-stack (;:needs-tos; provide-immediate; signed-immediate; t;)
...
some;
day ?
    (define-instruction |DoRationalQuotient| :operand-from-stack (;:needs-tos; provide-immediate; signed-immediate; t;)
    (BSR; r0 |BinaryArithmeticDivisionPrelude|;)
    (binary-arithmetic-one-value-division-operation; :rational;))

(define-instruction |DoFloor|; :operand-from-stack (;:needs-tos; provide-immediate; signed-immediate; t;)
    (BSR; r0 |BinaryArithmeticDivisionPrelude|;)
    (binary-arithmetic-two-value-division-operation; :down;))

(define-instruction |DoCeiling|; :operand-from-stack (;:needs-tos; provide-immediate; signed-immediate; t;)
    (BSR; r0 |BinaryArithmeticDivisionPrelude|;)
    (binary-arithmetic-two-value-division-operation; :up;))

(define-instruction |DoTruncate|; :operand-from-stack (;:needs-tos; provide-immediate; signed-immediate; t;)
    (BSR; r0 |BinaryArithmeticDivisionPrelude|;)
    (binary-arithmetic-two-value-division-operation; :truncate;))
 
(define-instruction |DoRound|; :operand-from-stack (;:needs-tos; provide-immediate; signed-immediate; t;)
    (BSR; r0 |BinaryArithmeticDivisionPrelude|;)
...
(define-instruction |DoMax|; :operand-from-stack
    (;:provide-immediate; signed-immediate; needs-tos; t;)
...
We;
don;
't use STACK-READ2, because it clears the sign extension
